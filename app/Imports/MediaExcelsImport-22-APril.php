...
class MediaExcelsImport implements ToModel, WithHeadingRow, WithCalculatedFormulas
{
    ...
    public function model(array $rows)
    {
        ...
        // dd($category->{'OD Media UID'});
            ...
            //     dd("First");
            // }
            $second=["media_category","media_sub_category","quantity","state","district","city","illumination_type","lit_type"];
            ...
            $three=["media_category","media_sub_category","length","width","quantity","state","district","city","size_type","illumination_type","lit_type"];
