...
trait CommonTrait 
{
   ...
   public function sendResponse($result, $message)
   {
    ...
    // }
        ...
        public function getLanguages()
   {
        $url = "http://192.168.10.60:8048/BC180/ODataV4/Company('BOC')/Language";
        $userName = 'RATAN';
    ...
    public function getRegionalLanguages(){
        ...
        return $this->sendResponse($result, ' Regional Language retrieved successfully.');*/
         $url = "http://192.168.10.60:8048/BC180/ODataV4/Company('BOC')/Language";
        $userName = 'RATAN';
        $password = 'omiUOOOpuzuV/0MjAtVCgCb51NEADiB7WQw/ocWlgWE=';
        $headers = array(
