...
class SoleRightMediaController extends Controller
{
    ...
    public function solerightlist3()
    {
        ...
        $vendor = DB::table('BOC$Vendor Emp - OD Media$3f88596c-e20d-438c-a694-309eb14559b2')->select('OD Media ID as media_id', 'HO E-Mail as ho_email', 'GST No_ as gst', 'HO Mobile No_ as mobile', 'Modification', 'Allocated Vendor Code as vendor_code', 'License From as from_date', 'License From as to_date')->where($where)->get();
        return view('admin.pages.soleright.sole-right-list', ["vendor" => $vendor]);
    }
    ...
    public function solerightlist2()
    {
        ...
        $vendor = DB::table('BOC$Vendor Emp - OD Media$3f88596c-e20d-438c-a694-309eb14559b2 as odv')
    ...
    public function existinguser()
    {
        ...
        $vendor = DB::table('BOC$Vendor Emp - OD Media$3f88596c-e20d-438c-a694-309eb14559b2')->select('*')->where(["User ID" => $user_id, "OD Category" => 0, "Modification" => 0])->first();
        if ($vendor) {
            $select = array(
                'OD Media Type',
                'Sole Media ID',
