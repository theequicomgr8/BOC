...
class TvComplianceController extends Controller
{
       ...
       //dd($complianceType);
        if ($userid != '' || $userid != null) {
            if (Session::has('UserName')) {
                DB::enableQueryLog();
                $response = DB::table('BOC$AV RO Header as ROH')
                ->select(
                    'ROH.RO Code',
                    'ROH.Agency Code',
                    'ROH.Agency Name',
                ...
                ->leftJoin('BOC$Language as lan', 'lan.Code', '=', 'ROH.Language')
                ->leftJoin('BOC$State as st', 'st.Code', '=', 'ROH.State')
    ...
    public function create()
    {
        ...
        //$userid = Session::get('UserID');
        //dd($userid);
        $agency_code=DB::table('BOC$AV Vendor')->select('Agency Code as agency_code','Name')
    ...
    public function getrolist($angcode){
        $ro_list = DB::table('BOC$AV RO Header')
    ...
    public function gettvchannellist($compliacetype){
        //dd($compliacetype[0]);
        $tvchannellist=DB::table('BOC$AV Vendor')->select('Agency Code as agency_code','Name')
    ...
    public function tvcompliancePdf($complianceType) {
        $userid = Session::get('UserID');
        $tvcompliancePdf = DB::table('BOC$AV RO Header as ROH')
        ->select(
            'ROH.RO Code',
            'ROH.Agency Code',
            'ROH.Agency Name',
