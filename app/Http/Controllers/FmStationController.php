...
$getlang =$this->getLanguage(@$FMdata->{'Language'});
$pdf= PDF::loadView('admin.pages.AV-pdf.pvt-fm-station',[ 'FMdata'=>$FMdata,'OD_owners'=>$OD_owners,'Time_band'=> $Time_band, 'Owner_State' =>$Owner_State, 'getlang'=>$getlang]);


return $pdf->download($id. '.pdf');
// $pdf=View('admin.pages.AV-pdf.pvt-fm-station',[ 'FMdata'=>$FMdata,'OD_owners'=>$OD_owners,'Time_band'=> $Time_band, 'Owner_State' =>$Owner_State, 'getlang'=>$getlang]);
// return $pdf;
}
