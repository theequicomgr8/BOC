...
class BulkSmsController extends Controller
{
    ...
    if(!empty($data)){
        ...
        //dd($district[0]['District']);
      return view('admin.pages.bulk-sms-obd-form',['result' => $states['original']['data'],'Bluksms'=>$data,'dist'=>$district]);
          }
    return view('admin.pages.bulk-sms-obd-form')->with(['result'=>$states['original']['data'], 'dist'=>$district] );
 }
