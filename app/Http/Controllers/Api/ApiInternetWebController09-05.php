...
class ApiInternetWebController extends Controller
{
    ...
    private $vendorTable ='BOC$Vend Emp Website';
    private $msg ='';
    ...
    {
            $table1 = '[BOC$Vend Emp Website]';
             $userid =session::get('UserID');
             $emailFind=DB::table('BOC$Vend Emp Website')->select('Agency Code')->where('User ID',$userid)->first();
                       $agency_name=
                         ...
                         //upload documents start
                                $FetchAllDoc =DB::table('BOC$Vend Emp Website')->where('User ID',$userid)->first();
                        ...
                        {
                        $agency_code = DB::select('select TOP 1 [Agency Code] from dbo.[BOC$Vend Emp Website] order by [Agency Code] desc');
