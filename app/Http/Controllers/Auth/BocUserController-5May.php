        ...
        if ($request->isMethod('post')) {
            ...
            if (empty($Ummuser) && empty($Ummusergst)) {
                ...
                if ($save) {
                    ...
                    // ];
                    // $this->mailSend($details,$request->email);

                    // return redirect('vendor-login')->with('success_message', 'Congratulation! You have successfully registered. Please confirm email address.');
