  ...
  $(".client-next-button").click(function(){
    ...
    messages: {      
      Name_of_Officer: {
        ...
        minlength: "Officer name must be at least 2 alphabets!",
      ...
      Designation: {
        ...
        maxlength: "Users can type only max 20 alphabets!"
      },
      email: {
        required: "Please fill required field!",
      ...
      phone: {
        maxlength: "Phone length should be max 12",
      },
      from_date:{
        required:"Please fill required field!"
      },
...
if(pageSize == "0"){
  ...
  $('#un_advertise_length').val("00");
  $('#un_advertise_breadth').val("00");
  $('#un_advertise_area').val("00");
  $('#un_advertise_length').prop("readonly",true);
  $('#un_advertise_breadth').prop("readonly",true);
  $('#un_advertise_area').prop("readonly",true);
  $('#printLength').show();
