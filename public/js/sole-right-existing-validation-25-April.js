    ...
    form.validate({
      ...
      messages: {
        ...
        "phone[]": {
          ...
          maxlength: "Phone number should be max and min 14 digit!",
          number: "Users can enter only integer numbers!"
        },
        "fax_no[]": {
          minlength: "Fax length should be min 3 digit!",
          maxlength: "Fax length should be max and min 14 digit!",
          number: "Users can enter only integer numbers!"
        },
        HO_Address: {
          required: "Please fill required field!"
        ...
        landline_authorized: {
          minlength: "Landline number should be min 3 digit!",
          maxlength: "Landline number should be max and min 14 digit!",
          number: "Users can enter only integer numbers!"
        },
        fax_authorized: {
          minlength: "Fax length should be min 3 digit!",
        ...
        GST_No: {
          maxlength: "Gst number length should be max and min 15 digit!",
          required: "Please fill required field!",
        },
        "Applying_For_OD_Media_Type[]": {
          required: "Please fill required field!",
    ...
    function formSubmit() {
      ...
      $.ajax({
        ...
        success: function (data) {
          console.log(data);
          swal("Your data have been submitted successfully. Please upload image through app. Your reference number is" + data.code).then(function () {
            window.location = 'sole-right-list';
          });
          // window.location.href = '/sole-right-existing-user';
        }
      });
    }
