...
$(document).ready(function () {
  $(".client-next-button").click(function () {
    ...
    if (form.valid() === true) {
      ...
      //   var str2 = items[j + 1].id;
      //   var tabId2 = str2.replace('-tab', '');
      //   // $(pane[i]).removeClass('show active');
      //   // $(pane[i + 1]).addClass('show active');
      //   // $("#" + str1 + '-tab').removeClass('show active');
      //   // $("#" + str2 + '-tab').addClass('show active');
      //   $("div#" + tabId1).removeClass('show active');
      //   $("div#" + tabId2).addClass('show active');
      //   // $("#" + str1).attr('aria-selected', 'false');
      //   // $("#" + str2).attr('aria-selected', tabId2);
      //   // console.log(items[i]);
      //   // console.log(items[i + 1]);
      //   // j = incr();
      //   for (j = 0; j < items.length; j++) {
      //     // console.log($('#'+items[j].id).hasClass('active'));
...
var text = '';
      ...
      next_fs.show();
      current_fs.hide();
      // else if ($('#AV-TV-tab').is(":visible")) {
      //   current_fs = $('#AV-TV-tab');
      //   next_fs = $('#AV-Radio-tab');
      //   $("a[id='#AV-TV-tab']").removeClass("active");
      //   $("a[id='#AV-Radio-tab']").addClass("active");
