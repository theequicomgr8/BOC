...
$("#HO_Same_Address_DO").click(function(){
  if($(this).is(":checked"))
  {
    ...
    if($("#HO_City").val() !=''){
     $("#HO_City").css("border-color", "#ced4da");
     $("#HO_City-error").hide();
    }
    if($("#HO_Phone_No").val() !=''){
     $("#HO_Phone_No").css("border-color", "#ced4da");
     $("#HO_Phone_No-error").hide();
    }
     if($("#HO_Fax").val() !=''){
     $("#HO_Fax").css("border-color", "#ced4da");
     $("#HO_Fax-error").hide();
    }
     if($("#HO_Mobile_No").val() !=''){
     $("#HO_Mobile_No").css("border-color", "#ced4da");
     $("#HO_Mobile_No-error").hide();
    }
     if($("#HO_E_Mail").val() !=''){
     $("#HO_E_Mail").css("border-color", "#ced4da");
     $("#HO_E_Mail-error").hide();
    }
     if($("#HO_PIN_Code").val() !=''){
     $("#HO_PIN_Code").css("border-color", "#ced4da");
     $("#HO_PIN_Code-error").hide();
    }
     if($("#HO_State").val() !=''){
     $("#HO_State").css("border-color", "#ced4da");
     $("#HO_State-error").hide();
    }
     if($("#HO_District").val() !=''){
     $("#HO_District").css("border-color", "#ced4da");
     $("#HO_District-error").hide();
    }
  ...
  else
  {
    ...
    if($("#HO_City").val() ==''){
     $("#HO_City").css("border-color", "#dc3545");
     $("#HO_City-error").show();
    }
    // if($("#HO_Phone_No").val() ==''){
    //  $("#HO_Phone_No").css("border-color", "#dc3545");
    //  $("#HO_Phone_No-error").show();
    // }
    //  if($("#HO_Fax").val() ==''){
    //  $("#HO_Fax").css("border-color", "#dc3545");
    //  $("#HO_Fax-error").show();
    // }
     if($("#HO_Mobile_No").val() ==''){
     $("#HO_Mobile_No").css("border-color", "#dc3545");
     $("#HO_Mobile_No-error").show();
    }
     if($("#HO_E_Mail").val() ==''){
     $("#HO_E_Mail").css("border-color", "#dc3545");
     $("#HO_E_Mail-error").show();
    }
     if($("#HO_PIN_Code").val() ==''){
     $("#HO_PIN_Code").css("border-color", "#dc3545");
     $("#HO_PIN_Code-error").show();
    }
     if($("#HO_State").val() ==''){
     $("#HO_State").css("border-color", "#dc3545");
     $("#HO_State-error").show();
    }
     if($("#HO_District").val() ==''){
     $("#HO_District").css("border-color", "#dc3545");
     $("#HO_District-error").show();
    }
  }
...
$("#checkbox1").click(function(){
  if($(this).is(":checked"))
  {
    ...
    if($("#OHO_Address").val() !=''){
     $("#OHO_Address").css("border-color", "#ced4da");
     $("#OHO_Address-error").hide();
    }
    if($("#OHO_City").val() !=''){
     $("#OHO_City").css("border-color", "#ced4da");
     $("#OHO_City-error").hide();
    }
    if($("#OHO_Phone_No").val() !=''){
     $("#OHO_Phone_No").css("border-color", "#ced4da");
     $("#OHO_Phone_No-error").hide();
    }
     if($("#OHO_Fax").val() !=''){
     $("#OHO_Fax").css("border-color", "#ced4da");
     $("#OHO_Fax-error").hide();
    }
     if($("#OHO_Mobile_No").val() !=''){
     $("#OHO_Mobile_No").css("border-color", "#ced4da");
     $("#OHO_Mobile_No-error").hide();
    }
     if($("#OHO_E_Mail").val() !=''){
     $("#OHO_E_Mail").css("border-color", "#ced4da");
     $("#OHO_E_Mail-error").hide();
    }
     if($("#OHO_PIN_Code").val() !=''){
     $("#OHO_PIN_Code").css("border-color", "#ced4da");
     $("#OHO_PIN_Code-error").hide();
    }
     if($("#OHO_State").val() !=''){
     $("#OHO_State").css("border-color", "#ced4da");
     $("#OHO_State-error").hide();
    }
     if($("#OHO_District").val() !=''){
     $("#OHO_District").css("border-color", "#ced4da");
     $("#OHO_District-error").hide();
    }
    ...
    $("#OHO_E_Mail").attr('value','');
     ...
     if($("#OHO_Address").val() ==''){
     $("#OHO_Address").css("border-color", "#dc3545");
     $("#OHO_Address-error").show();
    }
    if($("#OHO_City").val() ==''){
     $("#OHO_City").css("border-color", "#dc3545");
     $("#OHO_City-error").show();
    }
    // if($("#OHO_Phone_No").val() ==''){
    //  $("#OHO_Phone_No").css("border-color", "#dc3545");
    //  $("#OHO_Phone_No-error").show();
    // }
    //  if($("#OHO_Fax").val() ==''){
    //  $("#OHO_Fax").css("border-color", "#dc3545");
    //  $("#OHO_Fax-error").show();
    // }
     if($("#OHO_Mobile_No").val() ==''){
     $("#OHO_Mobile_No").css("border-color", "#dc3545");
     $("#OHO_Mobile_No-error").show();
    }
     if($("#OHO_E_Mail").val() ==''){
     $("#OHO_E_Mail").css("border-color", "#dc3545");
     $("#OHO_E_Mail-error").show();
    }
     if($("#OHO_PIN_Code").val() ==''){
     $("#OHO_PIN_Code").css("border-color", "#dc3545");
     $("#OHO_PIN_Code-error").show();
    }
     if($("#OHO_State").val() ==''){
     $("#OHO_State").css("border-color", "#dc3545");
     $("#OHO_State-error").show();
    }
     if($("#OHO_District").val() ==''){
     $("#OHO_District").css("border-color", "#dc3545");
     $("#OHO_District-error").show();
    }
  }
});
//Validation for number and .(Dot)
