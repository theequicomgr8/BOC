$(document).ready(function(){
   ...
   //new rob form start
    ...
    $("#tab_1,#tab_2,#tab_3").click(function(){
        ...
        if((txt_sop_theme_err==true) &&  (txt_from_err==true) && (txt_to_err==true) && (ddl_pro_activity_err==true) && (ddl_off_type_err==true) && (ddl_area_nature_err==true) && (ddl_area_act_err==true))
        {
...
// {
//     var ddl_doc_categ=$("#ddl_doc_categ").val();
//     if(ddl_doc_categ.length=="")
//     {
//         $("#document_type_err").show();
//         $("#document_type_err").html('Please Select Any One');
//         document_type_err=false;
//         return false;
//     }
//     else
//     {
//         $("#document_type_err").hide();
//     }
// }
