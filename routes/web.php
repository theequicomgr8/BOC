...
use App\Http\Controllers\billing\AV_RadioMediabilling\AVController;
...
Route::get('account_details', [SoleRightMediaController::class,'accountDetails'])->name('account_details');
...
// print route
Route::get('print-basic-detail', [FreshEmpanelmentController::class, 'basic_detail'])->name('basic_detail');
Route::post('print-basic-detail', [FreshEmpanelmentController::class, 'basic_detail_save'])->name('basic_detail_save');
...
Route::get('account-detail', [FreshEmpanelmentController::class, 'accountDetail'])->name('print-account-detail');
...
Route::get("usercreate", [SoleRightMediaController::class, 'datainsert']);


Route::get('tvbilling',[AVController::class,'index'])->name('tvbilling.index');
Route::get('tvbilling/create',[AVController::class,'create'])->name('tvbilling.create');
//AV Radio Media
