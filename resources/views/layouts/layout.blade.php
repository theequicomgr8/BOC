...
<body>
  ...
  @if($current_url=='vendor-login' || $current_url=='vendor-signup' || $current_url=='reset-password' || $current_url=='forgot-password'|| $current_url=='submitotp')
  ...
  @endif
    ...
    <div class="lgt-frm adt-cd">
      ...
      <footer class="loginfooter-lgn">
        ...
        @if($_SERVER['REQUEST_URI'] != '/rob-login')
            ...
            @endif
                            ...
                            <div class="btn-group fm2">
                              ...
                              <?php 
            if($_SERVER['REQUEST_URI'] == '/vendor-login' || $_SERVER['REQUEST_URI'] == '/vendor-signup' || $_SERVER['REQUEST_URI'] == '/reset-password' || $_SERVER['REQUEST_URI'] == '/forgot-password' || $_SERVER['REQUEST_URI'] == '/submitotp')
            {
        ...
        @elseif($_SERVER['REQUEST_URI'] == '/vendor-login' || $_SERVER['REQUEST_URI'] == '/vendor-signup' || $_SERVER['REQUEST_URI'] == '/reset-password' || $_SERVER['REQUEST_URI'] == '/forgot-password' || $_SERVER['REQUEST_URI'] == '/submitotp')
        <div class="btn-group fm4">
        ...
        <span class="pull-right">Support सहायता : 7330666740, 9319976363 </span>
      </footer>
    </div>
  </div> 
