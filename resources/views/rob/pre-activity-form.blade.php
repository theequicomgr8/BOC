     ...
     <form method="POST" class="client_request"  id="rob_request" enctype="multipart/form-data" >
      ...
      <div class="tab-content">
            ...
            <div class="col-xl-4">
              <div class="form-group">
                ...
                <select name="office_type" id="ddl_off_type" class="form-control form-control-sm" tabindex="{{$tab}}" style="pointer-events:{{$non}};" {{$block}}>
                  <option value="">--Select--</option>
                  <option id="ot1" value="HQ" {{@$data->office_type == "HQ"  ? 'selected' : ''}}>ROB {{@$offTyp->rob_hq}}  HEADQUARER</option>
            ...
            <div class="col-xl-4">
              <div class="form-group">
                <div class="form-group">
                  ...
                  <input name="duration_activity_from_date" value="{{@$data->duration_activity_from_date ?? ''}}" type="date" maxlength="10" id="txt_from" class="calendar1 form-control form-control-sm {{ $click }}" {{$block}}/>
        ...
        <div class="col-xl-4"><br>
          <input type="checkbox" name="pre_show_website" value="1" {{$check}}> Show On Website
        </div>
          </div>
          @if(@$data->sop_theme=='')
