                    ...
                    <table class="table table-striped text-center" id="example">
                        ...
                        <tbody>
                           ...
                           <tr>
                               ...
                               <td>{{$list->duration_activity_from_date}} {{$list->duration_activity_to_date}}</td>
                               <td>
                                @php
                               ...
                               <td>
                                ...
                                @if($list->approve == 1)
                                    <a href="{{URL::to('approve-rejected/0/').'/'.$list->Pk_id}}" title="Reject"><i class="fa fa-times" aria-hidden="true"></i></a>
                                   
                                @else
                                    <a href="{{URL::to('approve-rejected/1/').'/'.$list->Pk_id}}" title="Approve"><i class="fa fa-check" aria-hidden="true"></i></a>
                                @endif
                               </td>
                           </tr>
                           @endforeach
