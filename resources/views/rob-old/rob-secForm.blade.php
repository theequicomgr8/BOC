...
<!-- <TABLE id="Table1" style="WIDTH: 100%;" cellSpacing="0" cellPadding="0" align="center" border="0">
	<TR>
        ...
        <div class="row form-actions text-center">
            <h4 style="margin-left:45%;">Feeback Form For Outreach Programs<br />
                Page-2
            </h4>
        </div>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="span3">
                    <select name="document_type"  id="ddl_doc_categ" required>
            ...
            <div class="row ">
                ...
                <div class="span3">
                    <input name="event_date" type="date" required maxlength="10" id="txt_date_event" class="calendar1" />
                </div>
            </div>
            <div class="row ">
                <div class="span2">
                ...
                <div class="span3">
                    <input name="venue_event" type="text" required maxlength="50" id="txt_venue_event" /></div>
            </div>
            <input type="hidden" name="created_date" value="{{date('m/d/Y h:i:s a', time())}}">
            <div class="row">
                <div class="span2">
                    <span id="lbl_file_upload">Click to add files</span>

                </div>
                <div class="span3">
                    <input type="file" name="document_name[]" class="form-control" style="height:46px;" required>
