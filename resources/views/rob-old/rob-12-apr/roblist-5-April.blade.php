...
<div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <h6 class="m-0 text-primary"><i class="fa fa-edit"></i> Application for Client submission for advertisement |{{Session::get('UserName')}} </h6> 
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="rob-form-one/{{$item->Pk_id}}" style="text-decoration: none;color: blue;" id="view"><i class="fa fa-eye" style="font-size:30px;color:blue"></i></a>
                                </td>
                            </tr>
                            @php
                                $i++;
