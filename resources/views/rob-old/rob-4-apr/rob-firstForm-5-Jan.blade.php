...
<div class="content-inside p-3">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 text-primary"><i class="fa fa-edit"></i> Application for Client submission for advertisement |{{Session::get('UserName')}} || {{@$data->programme_activity}}</h6> 
    </div>
    <!-- Card Body -->
    <div class="row">
        <div class="col-xl-12">
            ...
            <div id="show_only_print_details1">
              <div class="row">
                ...
                <div class="col-xl-4">
                  ...
                  <a target="_blank" href="{{asset('rob/'.@$data->detail_report)}}">{{@$data->detail_report}}</a>
                </div>
                <div class="col-xl-4">
                  <table class="table borderless" id="FileUploadContainer">
                    <tr>
                        <td>File : <input type="file" name="document_name[]" id="pic" class="form-control form-control-sm" ></td>
                        <td><br><button class="btn btn-info" id="Button1">Add</button></td>
                    </tr>
                    <tr>
                      <td><span id="document_name_err" style="color: red;display: none;"></span></td>
                    </tr>
                  </table>
                  @if(@$rob_documents[0]->event_date!='')
...
$(document).ready(function(){
    ...
    $("#Button1").click(function(e){
        e.preventDefault();
        i++;
        $("#FileUploadContainer").append('<tr id="row'+i+'"><td>File : <input type="file" style="height:46px;" name="document_name[]" id="pic" class="form-control form-control-sm"></td><td><br><button class="btn btn-danger remove" id="'+i+'">X</button></td></tr>'+"<br><br>");
    });
