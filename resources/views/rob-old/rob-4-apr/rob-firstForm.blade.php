        ...
        <div id="logins-part" class="tab-pane active show">
          <div id="logins-part" class="content pt-3" role="tabpanel" aria-labelledby="logins-part-trigger">
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th style="width:40%;">PRE EVENT ACTIVITY</th>
                      <th>REMARKS</th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              <div class="col-xl-12">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th style="width: 10%;">Sr</th>
                      <th style="width: 30%;">PRE EVENT ACTIVITY</th>
                      <th>REMARKS</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div id="fixed" style="display: {{$fix_display}};">
              <div class="row">
                <div class="col-xl-12 text-left"><u>Main Programmes</u></div>
              </div>
              <div class="row">
                <div class="col-xl-12">
                  <table class="table table-bordered">
            ...
            <div id="show_only_print_details1">
              <div class="row">
                ...
                <div class="col-xl-4">
                  ...
                  @if(@$rob_documents[0]->event_date =='')
                    <input type="file" name="detail_report" class="form-control form-control-sm">
                    <span id="detail_report_err" style="color: red;display: none;"></span>
                  @endif
                  <a target="_blank" href="{{asset('rob/'.@$data->detail_report)}}">                    
                    {{@$data->detail_report}}</a>
                </div>
                <div class="col-xl-8">
                  @if(@$rob_documents[0]->event_date =='')
                  <table class="table borderless" id="FileUploadContainer">
                    <tr>
                        <td>
                          File : <input type="file" name="document_name[]" id="pic" class="form-control form-control-sm">
                          
                         <!--  @if(@$rob_documents[0]->event_date!='')
                          @foreach(@$rob_documents as $rob_document)
                          <a target="_blank" href="{{asset('rob/'.$rob_document->document_name)}}">{{@$rob_document->document_name}}</a><br>
                          
                          @endforeach
                          @endif -->
                        </td>
                        <td> Caption Name: <input type="text" name="caption_name[]" id="caption_name"  class="form-control form-control-sm">                        
                        </td>
                        @if(@$rob_documents[0]->event_date=='') <!-- when form is readable then add button not show -->
                ...
                @if(@$rob_documents[0]->event_date!='')
                   <table class="table table-bordered" style="margin-top:10px;">
                    ...
                    <tr>
                      ...
                      <td>{{@$rob_document->caption_name}}</td>
                    </tr>
                    @endforeach
                  </table>
                  @endif
              ...
              <div class="row">
                <div class="col-sm-12 text-right">
                 ...
                 @else
                 {{-- <button class="btn btn-primary client-next-button btn-sm m-0" disabled="disabled">Submit2</button> --}}
                 @endif
...
@endsection
@section('custom_js')
<!-- <script src="{{ url('/js') }}/submission-of-advertisement.js"></script> -->
...
$(document).ready(function(){
    ...
    $("#Button1").click(function(e){
        e.preventDefault();
        i++;
        $("#FileUploadContainer").append('<tr id="row'+i+'"><td>File : <input type="file" style="height:46px;" name="document_name[]" id="pic" class="form-control form-control-sm"></td><td> Caption Name: <input type="text" name="caption_name[]" id="caption_name" class="form-control form-control-sm"></td><td><br><button class="btn btn-danger remove" id="'+i+'">X</button></td></tr>'+"<br><br>");
    });
