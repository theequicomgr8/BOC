        ...
        <div id="logins-part" class="tab-pane active show">
          <div id="logins-part" class="content pt-3" role="tabpanel" aria-labelledby="logins-part-trigger">
            ...
            <div class="col-xl-4">
              <div class="form-group">
                ...
                <select name="office_type" id="ddl_off_type" class="form-control form-control-sm" tabindex="{{$tab}}" style="pointer-events:{{$non}};" {{$block}}>
                  <option value="">--Select--</option>
                  <option value="HQ" {{@$data->office_type == "HQ"  ? 'selected' : ''}}>ROB {{@$offTyp->rob_hq}} Headquarter</option>
                  <option value="FO" {{@$data->office_type == "FO"  ? 'selected' : ''}}>{{@$offTyp->rob_hq}} FOB</option>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td valign="middle">
                        <textarea maxlength="120" name="other_media_txt_pre_event" rows="2" cols="20" id="GridView1r_ctl06_txt_prev1" style="height:50px;display:{{$other_media_pre}};" class="form-control" {{$block}}>{{@$data->other_media_txt_pre_event ?? ''}}</textarea>
                      </td>
                    </tr>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td valign="middle">
                        <textarea maxlength="120" name="other_media_campaign_txt_pre_event" rows="2" cols="20" id="GridView1_ctl105_txt_prev9" style="height:50px;display:{{$other_media_campaign}};" class="form-control" {{$block}}>{{@$data->other_media_campaign_txt_pre_event ?? ''}}</textarea>
                      </td>
                    </tr>
            ...
            <div id="fixed" style="display: {{$fix_display}};">
              <div class="row">
                <div class="col-xl-12 text-left"><h5 style="color: blue;"><u>Post Event Activity</u></h5></div>
              </div>
              <div class="row">
                <div class="col-xl-12">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr id="exhibitions3"><!-- add new field -->
                        <td></td>
                        <td>
                          <span id="GridView2_ctl13_lbl_main_event_activity"></span>
                        </td>
                      ...
                      <tr id="exhibitions5"><!-- add new field 2022 7 APR -->
                        <td></td>
                        <td>
                          <span id="GridView2_ctl13_lbl_main_event_activity_standee"></span>
                        </td>
                        <td valign="middle">
                          <input id="exhibition_other_check_standee" value="1" type="checkbox" name="exhibition_other_check_standee" {{@$data->exhibition_other_check_standee=='1' ? 'checked' : ''}} tabindex="{{$tab}}" style="pointer-events:{{$non}};" {{$block}}/>
                          <span id="GridView2_ctl13_lbl_main_event_desc_standee">STANDEE</span>
                        </td>
                        @php
                        if(@$data->exhibition_other_check_standee=='1')
                        {
                          $exhibition_o_standee='';
                        }
                        else
                        {
                          $exhibition_o_standee='disabled';
                        }
                        @endphp
                        <td valign="middle">
                          <input name="exhibition_other_program_standee" type="text" maxlength="5" onkeypress="return onlyNumberKey(event)" id="exhibition_other_program_standee" {{$exhibition_o_standee}} class="numeric form-control" style="height:50px;" value="{{@$data->exhibition_other_program_standee ?? ''}}" {{$block}}/>
                        </td>
                        <td valign="middle">
                          <textarea maxlength="120" name="exhibition_other_program_remark_standee" rows="2" cols="20" id="exhibition_other_program_remark_standee" {{$exhibition_o_standee}} style="height:50px;" class="form-control" {{$block}}>
                            {{@$data->exhibition_other_program_remark_standee ?? ''}}
                          </textarea>
                        </td>
                      </tr>
                      ...
                      <tr id="faciliation2"><!-- add new field -->
                        <td></td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td valign="middle">
                          <textarea maxlength="120" name="led_main_remark" rows="2" cols="20" id="GridView2_ctl20_txt_main_remarl_mobile" {{$led_station}} style="height:50px;" class="form-control" {{$block}}>
                            {{@$data->led_main_remark ?? ''}}
                          </textarea>
                        </td>
                      </tr>
                      <tr id="mobile_medium2">
                        ...
                        <td valign="middle">
                          <textarea maxlength="120" name="auto_dd_main_remark" rows="2" cols="20" id="GridView2_ctl21_txt_main_remarl_mobile" {{$auto_air}} style="height:50px;" class="form-control" {{$block}}>
                            {{@$data->auto_dd_main_remark ?? ''}}
                          </textarea>
                        </td>
                      </tr>
                      <tr id="mobile_medium3">
                        ...
                        <td valign="middle">
                          <textarea maxlength="120" name="mini_auto_dd_main_remark" rows="2" cols="20" id="GridView2_ctl21_txt_main_remarl_mobile_mini" {{$mini_auto_air}} style="height:50px;" class="form-control" {{$block}}>
                            {{@$data->mini_auto_dd_main_remark ?? ''}}
                          </textarea>
                        </td>
                      </tr>
                      <tr id="mobile_medium4">
                        ...
                        <td valign="middle">
                          <textarea maxlength="120" name="video_auto_dd_main_remark" rows="2" cols="20" id="GridView2_ctl21_txt_main_remarl_mobile_video" {{$video_auto_air}} style="height:50px;" class="form-control" {{$block}}>
                            {{@$data->video_auto_dd_main_remark ?? ''}}
                          </textarea>
                        </td>
                      </tr>
                      ...
                      <tr id="mobile_medium5">
                        ...
                        <td valign="middle">
                          <textarea maxlength="120" name="other_auto_dd_main_remark" rows="2" cols="20" id="GridView2_ctl21_txt_main_remarl_mobile_other" {{$other_auto_air}} style="height:50px;" class="form-control" {{$block}}>
                            {{@$data->other_auto_dd_main_remark ?? ''}}
                          </textarea>
                        </td>
                      </tr>
            ...
            <div id="show_only_print_details1">
              <div class="row">
                ...
                <div class="col-xl-4">
                  ...
                  <input type="file" name="detail_report" class="form-control form-control-sm" accept="application/pdf">
