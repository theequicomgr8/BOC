...
<div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <h6 class="m-0 text-primary"><i class="fa fa-edit"></i> Pre Event Program List </h6> 
    </div>
                    ...
                    <table class="table table-striped text-center" id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item->duration_activity_from_date}}</td>
                                <td>
                                    <!-- <a href="rob-form-one/{{$item->Pk_id}}" class="btn btn-info" id="view">View</a> -->
                                    <a href="pre-active-form/{{$item->Pk_id}}" style="text-decoration: none;color: blue;" id="view"><i class="fa fa-eye" style="font-size:30px;color:blue"></i></a>
                                </td>
                            </tr>
                            @php
                                $i++;
