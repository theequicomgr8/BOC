  ...
  <div class="p-3">
    ...
    @else
      <?php
        ...
        else if(Session::get('WingType')=='M002')
        {
          $wing_type_name = '- AV';
          $wing_name = 'AV';
        }
        else if(Session::get('WingType')=='M003')
        {
          $wing_type_name = '- Outdoor';
          $wing_name = 'Outdoor';
        }
        else if(Session::get('WingType')=='M004')
        { 
          $wing_type_name = '- New Media';
          $wing_name = 'New Media';
        }
        else if(Session::get('WingType')=='M005')
        {
          $wing_type_name = '- PP';
          $wing_name = 'PP';
        }
    ...
    <ul class="list-unstyled components mb-5">
      ...
      <li>
        ...
        <!-- Private linking -->
        <!-- <a href="#personalEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i>Private Management</a>
        ...
        @elseif(Session::get('WingType')=='M001')

        <a href="#printEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i>{{$wing_name}} Management</a>
        ...
        @elseif(Session::get('WingType')=='M002')
