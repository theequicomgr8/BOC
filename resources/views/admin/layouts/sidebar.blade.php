  ...
  <div class="p-3">
    ...
    @else
      <?php
        ...
        {
          $wing_type_name = '- Category-A (Sole Right)';
          $wing_name = 'Category-A (Sole Right)';
        }
        else if(Session::get('WingType')==1)
        {
          $wing_type_name = '- Category-A (Personal)';
          $wing_name = 'Category-A (Personal)';
        }
    ...
    <ul class="list-unstyled components mb-5">
      ...
      <li>
        ...
        <!-- Soleright linking -->
        <a href="#solerightEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i> Category - A(Soleright)</a>
        ...
        <!-- Personal linking -->
        <a href="#personalEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i>Category - A(Personal)</a>
        ...
        @elseif(Session::get('WingType')==4)
          ...
          <a href="#av_tvEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i>AV-TV Management</a>
          ...
          <a href="#pvtfmEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i>PVT. FM Management</a>
          ...
          <a href="#avproducersEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i>AV Producers Management</a>
          ...
          <a href="#avproducersEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i>Digital Cinema</a>
          ...
          <a href="#avproducersEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i>Internet Website</a>
          ...
          <a href="#avproducersEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i>Bulk SMS</a>
         ...
         <!--  <a href="#crsEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i>CRS Management</a>

          <ul class="collapse list-unstyled" id="crsEmpanelment">
            <li>
              <a href="{{ url('community-radio-station') }}"><i class="fa fa-user-plus"></i> Fresh Empanelment</a>
            </li>

            <li>
              <a href="{{ url('commu-radio-fileupload') }}"><i class="fa fa-upload"></i> Agreement of Fresh Empanelment</a>
            </li>
        ...
        @if(Session::get('WingType')==0 || Session::get('WingType')==1 || Session::get('WingType')==2)
         <li>
          <a href="{{ route('account_details') }}"><i class="fa fa-edit" aria-hidden="true"></i> Account Management</a>
        </li>
        @elseif(Session::get('WingType')==3)
         <li>
          <a href="{{ route('print-account-detail') }}"><i class="fa fa-edit" aria-hidden="true"></i> Account Management</a>
        </li>
        @endif

        @if(Session::get('WingType')==0 || Session::get('WingType')==1 || Session::get('WingType')==2)
         <li>
          <a href="{{ route('sole-basic-detail') }}"><i class="fa fa-edit" aria-hidden="true"></i> Company Management</a>
        </li>
        @elseif(Session::get('WingType')==3)
         <li>
          <a href="{{ route('basic_detail') }}"><i class="fa fa-edit" aria-hidden="true"></i> Company Management</a>
        </li>
        @endif
      @endif
      @if(Session::get('UserType')==0)
