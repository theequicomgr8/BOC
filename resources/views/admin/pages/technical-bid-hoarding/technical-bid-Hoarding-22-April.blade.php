         ...
         <table class="table table-bordered">
            ...
            <tbody>
                  ...
                  <td colspan ="5">
                   <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control form-control-sm" name="headoffice_contact_person" onkeypress="return onlyAlphabets(event,this)" maxlength="50">
                    </div>
                    <div class="form-group col-md-12">
               ...
               <tr>
                  ...
                  <td colspan ="2"><input type="text" class="form-control form-control-sm" name="annual_turnover_2019_20_rs" placeholder="Please enter Rs." onkeypress="return onlyDotNumberKey(event)" maxlength="10"></td>
               </tr>
               <tr>
                  <td colspan ="3">FY 2020-21</td>
                  <td colspan ="2"><input type="text" class="form-control form-control-sm" name="annual_turnover_2020_21_rs" placeholder="Please enter Rs." onkeypress="return onlyDotNumberKey(event)" maxlength="10"></td>
               </tr>
               <tr>
