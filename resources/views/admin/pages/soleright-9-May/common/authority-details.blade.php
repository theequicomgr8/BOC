...
<div class="row" id="authority_details">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="date" name="License_To" maxlength="10" id="txt_to" maxlength="10" placeholder="DD/MM/YYYY" class="form-control form-control-sm" value="{{ $License_To !='' ? date('Y-m-d', strtotime($License_To)) : ''}}" {{@$disabled}} {{@$read}} tabindex="{{@$tab}}" style="pointer-events: '{{@$pointer}}';">
            <span id="date_error" style="color:red;display: none;"></span>
        </div>
    </div>
</div>
