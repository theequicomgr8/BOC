    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <div class="row">
                ...
                <div class="col-xl-3">
                    <a href="{{ url('sole-right-existing-user') }}" class="btn btn-info" style="float: right; font-size:13px">Add New Empanelment</a>
                </div>
                @else
                <div class="col-xl-3">
                    <a href="{{ url('sole-right-media') }}" class="btn btn-info" style="float: right; font-size:13px">Add New Empanelment</a>
                </div>
                @endif
            </div>
        </div>
