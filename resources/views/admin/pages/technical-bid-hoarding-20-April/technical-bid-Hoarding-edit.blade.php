            ...
            <tbody>
               <tr>
                  ...
                  <td colspan ="5">
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" value="{{ $bid_hoarding_data->agency_name }}"  name="agency_name" placeholder="Please enter agency name" required="required">
                     </div>
                  </td>
               </tr>
               <tr>
                   ...
                   <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12">
                     ...
                     <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control form-control-sm" name="headoffice_telephone" value="{{ $bid_hoarding_data->headoffice_telephone }}">
                    </div>
                     <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control form-control-sm" name="headoffice_contact_person" value="{{ $bid_hoarding_data->headoffice_contact_person }}">
                    </div>
                    <div class="form-group col-md-12">
               ...
               <tr class="Branch_office_section">
                  ...
                  <td colspan="5">
                    ...
                    <div class="form-group col-md-12">
                        <label for="companyName" class="mr-2 col-form-label-sm">Contact person:</label>
                        <input type="text" class="form-control form-control-sm" value="{{ $branch_office->branchoffice_contact_person }}" name="branchoffice_contact_person[]">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="companyName" class="mr-2 col-form-label-sm">Whether electricity bill of past six months submitted:</label>
                        <label class="form-check-label ml-4">
               ...
               <tr>
                  ...
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2018_19_qty_pos" placeholder="Please enter Qty. of POs" value="{{ $bid_hoarding_data->work_order_2018_19_qty_pos }}">
                     </div>
                  </td>
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2018_19_qty_hording" placeholder="Please enter Qty. of hoardings" value="{{ $bid_hoarding_data->work_order_2018_19_qty_hording }}">
                     </div>
                  </td>
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2018_19_amount" placeholder="Please enter Amount (in rupees)" value="{{ $bid_hoarding_data->work_order_2018_19_amount }}">
                     </div>
                  </td>
                   <td>
                     <div class="form-group">
               ...
               <tr>
                  ...
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2019_20_qty_pos" placeholder="Please enter Qty. of POs" value="{{ $bid_hoarding_data->work_order_2019_20_qty_hording }}">
                     </div>
                  </td>
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2019_20_qty_hording" placeholder="Please enter Qty. of hoardings" value="{{ $bid_hoarding_data->work_order_2019_20_amount }}">
                     </div>
                  </td>
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2019_20_amount" placeholder="Please enter Amount (in rupees)" value="{{ $bid_hoarding_data->work_order_2019_20_amount }}">
                     </div>
                  </td>
                   <td>
                     <div class="form-group">
               ...
               <tr>
                  ...
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2020_21_qty_pos" placeholder="Please enter Qty. of POs" value="{{ $bid_hoarding_data->work_order_2020_21_qty_pos}}">
                     </div>
                  </td>
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2020_21_qty_hording" placeholder="Please enter Qty. of hoardings" value="{{ $bid_hoarding_data->work_order_2020_21_qty_hording }}">
                     </div>
                  </td>
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2020_21_amount" placeholder="Please enter Amount (in rupees)" value="{{ $bid_hoarding_data->work_order_2020_21_amount }}">
                     </div>
                  </td>
                    <td>
                     <div class="form-group">
                  ...
                  <td colspan ="2"><input type="text" class="form-control form-control-sm" name="annual_turnover_2019_20_rs" placeholder="Please enter Rs." value="{{ $bid_hoarding_data->annual_turnover_2019_20_rs }}"></td>
               </tr>
               <tr>
                  <td colspan ="3">FY 2020-21</td>
                  <td colspan ="2"><input type="text" class="form-control form-control-sm" name="annual_turnover_2020_21_rs" placeholder="Please enter Rs." value="{{ $bid_hoarding_data->annual_turnover_2020_21_rs }}"></td>
               </tr>
               <tr>
                  ...
                  <td colspan ="2">
                     <div class="form-group">
                        <select class="form-control form-control-sm" name=" details_authorized_list_location[]" id="sel1">
                           ...
                           <option <?php echo ($details_authorized->details_authorized_list_location == 2) ? 'selected="selected"' : '' ?> value="3">No</option>
                        </select>
                     </div>
                  </td>
               </tr>
