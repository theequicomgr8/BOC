...
<body>
    <div class="container pt-4">
        <h4 class="text-left" style="text-align: center;"><u>Evaluation of Technical Bid for Bid Hoarding</u> <a
                href="{{ url('bidHoarding-export-pdf/' . Request::segment(2)) }}" id="download"
    ...
    <tr>
        <td colspan="4">2. GST Registration Certificate:
                     @if($bid_hoarding_data->legal_document_gst_registration == 1)<br>&nbsp;&nbsp;&nbsp; GST Number @endif
        </td>
        <td>
            <label>
    ...
    <tr>
        <td colspan="4">3. PAN/TAN Card: 
            @if($bid_hoarding_data->legal_document_pan == 1)<br>&nbsp;&nbsp;&nbsp; Pan Number @endif
        </td>        
        <td>
            <label>
