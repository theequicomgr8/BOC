...
<html lang="en">
   ...
   <body>
      <div class="container pt-4">
         ...
         <form Method="post" action="{{url('/TechnicalHoarding')}}" enctype="multipart/form-data" id="company_details">
         @csrf
         <table class="table table-bordered">
            ...
            <tbody>
               <tr>
                  ...
                  <td colspan ="5">
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm"  name="agency_name" placeholder="Please enter agency name" required="required">
                     </div>
                  </td>
               </tr>
               <tr>
                  ...
                  <td colspan ="5">
                   <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control form-control-sm" name="headoffice_contact_person">
                    </div>
                    <div class="form-group col-md-12">
               ...
               <tr class="Branch_office_section">
                  ...
                  <td colspan="5">
                    ...
                    <div class="form-group col-md-12">
                     ...
                     <div class="form-group col-md-12">
                        <label for="companyName" class="mr-2 col-form-label-sm">Telephone no.:</label>
                        <input type="text" class="form-control form-control-sm" name="branchoffice_telephone[]">
                    </div>
                     <div class="form-group col-md-12">
                        <label for="companyName" class="mr-2 col-form-label-sm">Email:</label>
                        <input type="email" class="form-control form-control-sm" name="branchoffice_email[]">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="companyName" class="mr-2 col-form-label-sm">Contact person:</label>
                        <input type="text" class="form-control form-control-sm" name="branchoffice_contact_person[]">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="companyName" class="mr-2 col-form-label-sm">Whether electricity bill of past six months submitted:</label>
                        <label class="form-check-label ml-4">
               ...
               <tr>
                  ...
                  <td colspan ="2">
                     <div class="form-group">
                        ...
                        <br>
                        <input type="text" name="gst_number" class="form-control form-control-sm" id="gst_number_input" value="" style="display:none;">
                     </div>
                  </td>
               </tr>
               <tr>
                  ...
                  <td colspan ="2">
                     <div class="form-group">
                        ...
                        <br>
                        <input type="text" name="pan_card" class="form-control form-control-sm" id="pan_card_input" value="" style="display:none;">
                     </div>
                  </td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2018_19_qty_pos" placeholder="Please enter Qty. of POs">
                     </div>
                  </td>
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2018_19_qty_hording" placeholder="Please enter Qty. of hoardings">
                     </div>
                  </td>
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2018_19_amount" placeholder="Please enter Amount (in rupees)">
                     </div>
                  </td>
                   <td>
                     <div class="form-group">
               ...
               <tr>
                  ...
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2019_20_qty_pos" placeholder="Please enter Qty. of POs">
                     </div>
                  </td>
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2019_20_qty_hording" placeholder="Please enter Qty. of hoardings">
                     </div>
                  </td>
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2019_20_amount" placeholder="Please enter Amount (in rupees)">
                     </div>
                  </td>
                   <td>
                     <div class="form-group">
               ...
               <tr>
                  ...
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2020_21_qty_pos" placeholder="Please enter Qty. of POs">
                     </div>
                  </td>
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2020_21_qty_hording" placeholder="Please enter Qty. of hoardings">
                     </div>
                  </td>
                  <td>
                     <div class="form-group">
                        <input type="text" class="form-control form-control-sm" name="work_order_2020_21_amount" placeholder="Please enter Amount (in rupees)">
                     </div>
                  </td>
                    <td>
                     <div class="form-group">
                  ...
                  <td colspan ="2"><input type="text" class="form-control form-control-sm" name="annual_turnover_2019_20_rs" placeholder="Please enter Rs."></td>
               </tr>
               <tr>
                  <td colspan ="3">FY 2020-21</td>
                  <td colspan ="2"><input type="text" class="form-control form-control-sm" name="annual_turnover_2020_21_rs" placeholder="Please enter Rs."></td>
               </tr>
               <tr>
