...
<div id="media_address">
    ...
    <div class="row" id="media_empty">
        ...
        <div class="col-md-2" style="padding: 2% 0 0 6%; display: {{$key==0 ? 'none' :'block'}}"><button class="btn btn-danger remove_row" data="{{$key}}" style="display: {{@$show}};font-size: 13px;"><i class="fa fa-minus"></i> Remove</button>
