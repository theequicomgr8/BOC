...
<div class="content-inside p-3">
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-normal text-primary">Details of owner (Proprietor/Partner/Directors) Of Company
            </h6>
        </div>
        <!-- Card Body -->
        <div class="card-body">
                        ...
                        <div class="row" id="details_of_owner">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="owner_name">Publication Name / प्रकाशन का
                                        नाम</label>
                                    <p>
                                        <input type="text" name="owner_name[]" id="owner_name0" placeholder="Enter Publication Name" class="form-control form-control-sm owner_name" onkeypress="return onlyAlphabets(event,this);" maxlength="40" value="{{$ownerlist['Owner Name']?? ''}}" {{ @$readonly }}>
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <p>
                                        <input type="email" class="form-control form-control-sm" id="owner_email0" name="owner_email[]" maxlength="50" placeholder="Enter Email ID" value="{{$ownerlist['Email ID']?? ''}}" onkeyup="return checkUniqueOwnerSoleRight(this, this.value,0)" {{ @$readonly }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <p>
                                        <input type="text" name="mobile[]" id="owner_mobile0" maxlength="10" placeholder="Enter Mobile" class="form-control form-control-sm input-imperial" onkeypress="return onlyNumberKey(event)" maxlength="10" value="{{$ownerlist['Mobile No_']?? ''}}" onkeyup="return checkUniqueOwnerSoleRight(this, this.value,0)" {{ @$readonly }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <p>
                                        <textarea type="text" name="address[]" id="owner_address0" maxlength="120" placeholder="Enter Address" rows="1" class="form-control form-control-sm" {{ @$readonly }}>{{$ownerlist['Address 1']?? ''}}</textarea>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <p>
                                        <select id="owner_state0" name="state[]" class="form-control form-control-sm call_district" data="owner_district0" {{$disabled}}>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <p>
                                        <select id="owner_district0" name="district[]" class="form-control form-control-sm" {{$disabled}}>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <p>
                                        <input type="text" name="city[]" id="owner_city0" maxlength="20" class="form-control form-control-sm" placeholder="City" value="{{$ownerlist['City']?? ''}}" {{ @$readonly }}>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone[]" id="owner_phone0" maxlength="14" onkeypress="return onlyNumberKey(event)" placeholder="Enter Phone No" class="form-control form-control-sm input-imperial" value="{{$ownerlist['Phone No_']?? ''}}" {{$disabled}}>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                    ...
                    <div id="tab2" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab1-trigger">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="HO_Address" id="address1" maxlength="120" placeholder="Enter Address" rows="1" class="form-control form-control-sm" {{$disabled}}>{{$vendor_data[0]['HO Address']??''}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="HO_Email" placeholder="Enter E-mail" class="form-control form-control-sm" id="HO_Email" value="{{$vendor_data[0]['HO E-Mail']??''}}" {{$disabled}} maxlength="50" onkeyup="return checkUniqueVendor('email', this.value)">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="BO_Landline_No" placeholder="Enter Landline No." class="form-control form-control-sm" id="landline_no" maxlength="14" onkeypress="return onlyNumberKey(event)" value="{{$vendor_data[0]['BO Landline No_']??''}}" {{$disabled}}>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="fax_no">Fax No. / फ़ैक्स नंबर</label>
                                    <input type="text" name="BO_Fax_No" placeholder="Enter Fax No." class="form-control form-control-sm" id="fax_no" maxlength="14" onkeypress="return onlyNumberKey(event)" value="{{$vendor_data[0]['BO Fax No_']??''}}" {{$disabled}}>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="email">E-mail. / ईमेल</label>
                                    <input type="text" name="BO_Email" placeholder="Enter E-mail" class="form-control form-control-sm" id="email" maxlength="30" value="{{$vendor_data[0]['BO E-Mail']??''}}" {{$disabled}}>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="mobile">Mobile / मोबाइल</label>
                                    <input type="text" name="BO_Mobile" placeholder="Enter Mobile" class="form-control form-control-sm" id="mobile" onkeypress="return onlyNumberKey(event)" maxlength="10" value="{{$vendor_data[0]['BO Mobile No_']??''}}" {{$disabled}}>
                                </div>
                            </div>
                        </div>
                        <div class="row col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="address">Address / पता</label>
                                    <textarea {{$disabled}} type="text" name="AR_Address" maxlength="120" placeholder="Enter Address" rows="1" class="form-control form-control-sm">{{$vendor_data[0]['AR Address']??''}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="landline_no">Landline No. / लैंडलाइन नंबर</label>
                                    <input type="text" name="AR_Landline_No" placeholder="Enter Landline No." class="form-control form-control-sm" id="landline_no" onkeypress="return onlyNumberKey(event)" maxlength="14" value="{{$vendor_data[0]['AR Landline No_']??''}}" {{$disabled}}>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="email">E-mail. / ईमेल</label>
                                    <input type="text" name="AR_Email" placeholder="Enter E-mail" class="form-control form-control-sm" id="email" maxlength="30" value="{{$vendor_data[0]['AR E-mail']??''}}" {{$disabled}}>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="mobile">Mobile / मोबाइल</label>
                                    <input type="text" name="AR_Mobile_No" placeholder="Enter Mobile" class="form-control form-control-sm" id="mobile" onkeypress="return onlyNumberKey(event)" maxlength="10" value="{{$vendor_data[0]['AR Mobile No_']??''}}" {{$disabled}}>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row" id="authority_details">
                            ...
                            <div class="col-md-4" style="margin-top: 26px;">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Contract_No" placeholder="Enter Amount Paid to Authority For The Current Year" onkeypress="return onlyNumberKey(event)" class="form-control form-control-sm" id="Contract_No" maxlength="13" value="{{$vendor_data[0]['Contract No_']??''}}" {{$disabled}}>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="License_Fee" id="license_fee" placeholder="Enter License Fee" onkeypress="return onlyNumberKey(event)" class="form-control form-control-sm" maxlength="8" value="{{ @$vendor_data[0]['License Fees'] ? round(@$vendor_data[0]['License Fees'],2) : ''}}" {{$disabled}}>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Quantity_Of_Display" id="quantity_of_dis" placeholder="Quantity of Display" class="form-control form-control-sm" onkeypress="return onlyNumberKey(event)" maxlength="8" value="{{$vendor_data[0]['Quantity Of Display']??''}}" {{$disabled}}>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row" id="media_address">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select {{$disabled}} id="state_id_0" name="MA_State[]" class="form-control form-control-sm call_district" data="dist_id_0" {{$disabled}}>
                                        <option value="">Select State</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select {{$disabled}} id="dist_id_0" name="MA_District[]" class="form-control form-control-sm">
                                        <option value="">Select District</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="Name">City / नगर<font color="red">*</font></label>
                                    <input type="text" name="MA_City[]" class="form-control form-control-sm" placeholder="Enter City" maxlength="20" value="{{$OD_media_address['City']?? ''}}" {{$disabled}}>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="license_to">Zone / क्षेत्र</label>
                                    <input type="text" name="MA_Zone[]" placeholder="Zone" class="form-control form-control-sm" id="zone" maxlength="8" value="{{$OD_media_address['Zone']?? ''}}" {{$disabled}} onkeypress="return onlyNumberKey(event)">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="MA_Latitude[]" placeholder="Latitude" class="form-control form-control-sm lat_cls" id="Latitude" onkeypress="return onlyDotNumberKey(event)" maxlength="19" value="{{$OD_media_address['Latitude']?? ''}}" {{$disabled}}>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="MA_Longitude[]" placeholder="Longitude" class="form-control form-control-sm lat_cls" id="Longitude" onkeypress="return onlyDotNumberKey(event)" maxlength="19" value="{{$OD_media_address['Longitde']?? ''}}" {{$disabled}}>
                                </div>
                                <span id="alert_lat" style="color: red; display: none">Please enter
                                    decimal value. For Example: 779997.899</span>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="MA_Property_Landmark[]" placeholder="Property Landmark" class="form-control form-control-sm" id="property_landmark" maxlength="80" value="{{$OD_media_address['Landmark']?? ''}}" {{$disabled}}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="margin-top: 24px;">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ODMFO_Display_Size_Of_Media" placeholder="Display size of media" class="form-control form-control-sm" id="size_of_media" maxlength="18" value="{{ @$vendor_data[0]['Media Display size'] ? round(@$vendor_data[0]['Media Display size'],2) : ''}}" {{$disabled}}>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="year">Illumination / रोशनी</label>
                                    <input type="text" name="Illumination_media" placeholder="Illumination" onkeypress="return onlyNumberKey(event)" class="form-control form-control-sm" id="Illumination" maxlength="9" value="{{$vendor_data[0]['Illumination']??''}}" {{$disabled}}>
                                </div>
                            </div>
                        </div>
                        <div class="row col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <span class="input-group-text"><a href="{{ url('/uploads') }}/sole-right-media/{{ $work_done_data['File Name'] }}" target="_blank">View</a></span>
                                        </div>
                                        @else
                                        <div class="input-group-append">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="Other_Relevant_Information" id="tin_tan_vat_no" placeholder="Enter Any other relevant information" maxlength="80" value="{{$vendor_data[0]['Other Relevant Information'] ?? ''}}" {{$disabled}}>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="tab4" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab1-trigger">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text"><a href="{{ url('/uploads') }}/sole-right-media/{{ $vendor_data[0]['Notarized Copy File Name'] }}" target="_blank">View</a></span>
                                </div>
                                @else
                                <div class="input-group-append">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text"><a href="{{ url('/uploads') }}/sole-right-media/{{ $vendor_data[0]['Photo File Name'] }}" target="_blank">View</a></span>
                                </div>
                                @else
                                <div class="input-group-append">
                        ...
                        <a class="btn btn-primary" onclick="nextSaveData('submit_btn');">Submit</a>
