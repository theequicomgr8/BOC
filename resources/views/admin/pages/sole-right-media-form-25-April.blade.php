                ...
                <div class="tab-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <p>
                                            <select id="owner_state0" name="state[]" class="form-control form-control-sm call_district owner_state" data="owner_district{{$key}}" {{$read}} tabindex="{{$tab}}" style="pointer-events: {{$pointer}};">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <p>
                                            <input type="text" name="city[]" id="owner_city{{$key}}" maxlength="20" class="form-control form-control-sm owner_city" placeholder="City" value="{{$ownerlist['City']?? ''}}" onkeypress="return onlyAlphabets(event)" {{$read}} tabindex="{{$tab}}" style="pointer-events: '{{$pointer}}';">
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                    ...
                    <div id="tab2" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab1-trigger">
                        ...
                        <div class="row" style="float:right;margin-top: 6px;margin-right: 0px;" id="addid">
                            ...
                            <a class="btn btn-primary" id="add_branch" style="pointer-events: {{$pointer}}; display: {{$show}};"><i class="fa fa-plus" aria-hidden="true"></i> Add New</a>
                        </div>
                        ...
                        <div id="radioar">
                            ...
                            <div class="row" id="auth_detail">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="mobile">Mobile No. / मोबाइल नंबर <font color="red">*</font></label>
                                        <input type="text" name="AR_Mobile_No[]" placeholder="Enter Mobile" class="form-control form-control-sm" id="mobile" onkeypress="return onlyNumberKey(event)" maxlength="10" minlength="10" value="{{$auth->{'AR Mobile'} ??''}}" {{$disabled}} {{$read}} tabindex="{{$tab}}" style="pointer-events: '{{$pointer}}';">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="altername_mobile[]" placeholder="Enter Mobile" class="form-control form-control-sm" id="altername_mobile" onkeypress="return onlyNumberKey(event)" maxlength="10" minlength="10" value="{{$auth->{'Alternate Mobile No_'} ??''}}" {{$disabled}} {{$read}} tabindex="{{$tab}}" style="pointer-events: '{{$pointer}}';">
                                    </div>
                                </div>
                        ...
                        <div class="row" style="float:right;margin-top: 6px;margin-right: 0px;">
                            ...
                            <a class="btn btn-primary {{$disabled}}" id="add_Auth" {{$read}} tabindex="{{$tab}}" style="pointer-events: {{$pointer}}; display: {{$show}};"><i class="fa fa-plus" aria-hidden="true"></i> Add New</a>
                        </div>
                        <!-- For Add function 8-Feb end -->
                        <br>
                        <div class="row col-md-12">
                        ...
                        <div id="details_of_work_done">
                            ...
                            <div class="row" id="workid{{$key}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4" style="display: {{$key==0 ? 'none' :'block'}}"><button class="btn btn-danger remove_row_next" data="{{$key}}" data-hide="workid{{$key}}" style="display: {{$show}}; margin-left: 62px;"><i class="fa fa-minus"></i> Remove</button>
                        ...
                        <div class="row" style="float:right;margin: 6px 0 0 0;">
                            ...
                            <a class="btn btn-primary {{$disabled}}" id="add_row_next" {{$read}} tabindex="{{$tab}}" style="pointer-events: {{$pointer}}; display: {{$show}};"><i class="fa fa-plus" aria-hidden="true"></i>
                                Add New</a>
                        </div><br><br>
