 ...
 @php 
       ...
       <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            @if(@$FMdata->{'Modification'} == 1)
            <p><a href="{{url('avFMpdf/'.@$FMdata->{'FM Station ID'} ?? '')}}" class="m-0 font-weight-normal text-primary"> <i class="fa fa-download"></i>Pvt. FM station application Receipt</a></p>
            @endif
        </div>
        <!-- Card Body -->
        <div class="card-body">
          ...
          <div class="col-md-2">
           ...
           <div class="col-md-2" id="to">
              <div class="form-group">
                <label for="To">To:</label>
                <input type="time" class="form-control form-control-sm"
                id="Sun_TB2_To" name="Sun_TB2_To" data-id="Sun_TB2_" data-deep="Sun_TB3_"  {{$disabled}}  value="{{$sun_tb2_t ?? ''}}">
             </div>
            </div>
              @php
