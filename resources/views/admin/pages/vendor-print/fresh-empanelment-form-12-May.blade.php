        ...
        <div class="tab-content">
            ...
            <div class="row">
              ...
              <div class="col-md-4" id="rni_regist_no" style="display: {{$rni_regist_no}};">
                <div class="form-group">
                  ...
                  <input type="text" name="rni_registration_no" maxlength="17" placeholder="Enter RNI Registration No." class="form-control form-control-sm" id="rni_registration_no" value="{{ $reg_no }}" onchange="return checkRegCIRBase(this.value)" {{$disabledall}}>
              ...
              <div class="col-md-4" id="abc-certificate" style="display: {{$abc_cert}};">
                <div class="form-group">
                  ...
                  <input type="text" name="abc_certificate_no" maxlength="15" placeholder="Enter ABC Certificate No." class="form-control form-control-sm"  id="abc_certificate_no" value="{{ $vendordatas['ABC Number'] ?? ''}}" onchange="return checkRegCIRBase(this.value)" {{ $disabledall }}>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="claimed_circulation" maxlength="8" data-deep="claimed_circulation" placeholder="Enter Claimed Circulation No." class="form-control  form-control-sm" id="claimed_circulation" onkeyup="return checkCirculation(this.value)" onkeypress="return onlyNumberKey(event)" value="{{ $solid_circulation }}" {{$disabledall}}>
          ...
          <div id="tab2" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab2-trigger">
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="v_email">Email ID(Vendor) / ई मेल आईडी<font color="red">*</font></label>
                  <input type="email" class="form-control  form-control-sm" maxlength="40" id="v_email" name="v_email" placeholder="Enter Email ID" value="{{ $vendordatas['Email ID'] ?? session('email') }}" onchange="return checkUniqueVendor('email', this.value)" {{$disabledall}}>
                  <input type="hidden" name="vendor_v_email" id="vendor_email" value="{{ $vendordatas['Email ID'] ?? '' }}">
          ...
          <div id="tab4" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab4-trigger">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                @endphp
                <div class="form-group">
                  <label for="specimen_copy_file_name1"> <span id="speciman_copy">{{$speciman_copy}}</span>
                    <font color="red">*</font>
                  </label>
                  <div class="input-group">
