            ...
            <table class="table table-striped table-bordered table-hover order-list text-size" id="myTable" width="100%"> 
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="4">
                    ...
                    <tr>
                        ...
                        <td><strong>:</strong></td>
                        <td colspan="4">{{ $vendordatas['Claimed Circulation'] ?? ''}}</td>
                    </tr>
                    @endif
                ...
                <tr>
                    ...
                    <tr>
                        <td><strong>Address</strong></td>
                        <td><strong>:</strong></td>
                        <td>{{ strtolower($vendordatas['Address']) }}</td>
                        <td><strong>State</strong></td>
                        <td><strong>:</strong></td>
                    ...
                    <tr>
                        ...
                        <td><strong>:</strong></td>
                        <td>{{ strtolower($vendordatas['Press Email']) }}</td>
                    ...
                    <tr>
                        ...
                        <td><strong>:</strong></td>
                        <td>{{ strtolower($vendordatas['Address of Press']) ?? ''}}</td>
                    ...
                    <tr>
                        ...
                        <td>{{ ucwords($CAName) ?? ''}}</td>
                        <td><strong>CA Address</strong></td>
                        <td><strong>:</strong></td>
                        <td>{{ strtolower($vendordatas['CA Address']) ?? ''}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><strong>:</strong></td>
                        <td colspan="4">{{ $vendordatas['Change In Company Address'] == "0" ? 'No' : 'Yes'}}</td>
                    </tr>
                <tr>
                    <th colspan="6"><hr /></th>
                </tr>
                    ...
                    <tr>
                        ...
                        <td>{{ ucwords($AccountHolderName) }}</td>
                    ...
                    <tr>
                        ...
                        <td><strong>:</strong></td>
                        <td>{{ strtolower($vendordatas['Account Address']) }}</td>
