...
if( !empty($np_rate_renewal) && @$np_rate_renewal[0]->{'Status'} != 0 && @$np_rate_renewal[0]->{'Status'} != 6 ){ $renewal_readonly='readonly' ; $policy_check='checked' ; $renewal_disabled = 'disabled'; }
...
$abc_cert = 'none';
$abc_reg_no_verified = '';
if((@$np_rate_renewal[0]->{'CIR Base'} == 0 || @$vendor_datas->{'CIR Base'} == 0 ) || (@$np_rate_renewal[0]->{'RNI Circulation'} == 1 && @$np_rate_renewal !='')){
$reg_no = @$np_rate_renewal[0]->{'RNI Registration No_'} ?? $vendor_datas->{'RNI Registration No_'} ?? '';
$solid_circulation = $np_rate_renewal[0]->{'circulation'} ?? $vendor_datas->{'Claimed Circulation'} ?? '';
$efiling = 'block';
$rni_regist_no = 'block';
$abc_cert = 'none';

$reg_no_verified = @$np_rate_renewal[0]->{'RNI Registration Validation'} ?? $vendor_datas->{'RNI Registration Validation'} ?? '';
$solid_circulation_verified = @$np_rate_renewal[0]->{'RNI Circulation Validation'} ?? $vendor_datas->{'RNI Circulation Validation'} ?? '';
$turnover_verified = @$np_rate_renewal[0]->{'RNI Annual Validation'} ?? $vendor_datas->{'RNI Annual Validation'} ?? '';

$date_verified = $np_rate_renewal[0]->{'RNI Validation Date'} ?? $vendor_datas->{'RNI Validation Date'} ?? '';
}

if((@$np_rate_renewal[0]->{'CIR Base'} == 3 || @$vendor_datas->{'CIR Base'} == 3) || (@$np_rate_renewal[0]->{'ABC Circulation'} == 1 && @$np_rate_renewal !='')){
$solid_circulation = $np_rate_renewal[0]->{'circulation'} ?? $vendor_datas->{'ABC Circulation Number'} ?? '';
$efiling = 'none';
$rni_regist_no = 'none';
$abc_cert = 'block';

$abc_reg_no_verified = $np_rate_renewal[0]->{'ABC Registration Validation'} ?? $vendor_datas->{'ABC Registration Validation'} ?? '';
$solid_circulation_verified = $np_rate_renewal[0]->{'ABC Circulation Validation'} ?? $vendor_datas->{'ABC Circulation Validation'} ?? '';

$date_verified = $np_rate_renewal[0]->{'ABC Validation Date'} ?? $vendor_datas->{'ABC Validation Date'} ?? '';
}
        ...
        <div class="tab-content">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="hidden" name="ownerid" id="ownerid" value="{{ @$owner_datas[0]->{'Owner ID'} ??'' }}">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
          ...
          <div id="tab2" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab2-trigger">
            <div class="row">
              <div class="col-md-4">
                @php
                $gst_readonly = '';
                if(@$np_rate_renewal[0]->{'DM Declaration'} == 0){
                $gst_readonly = 'readonly';
                }
                @endphp
                <div class="form-group">
                  <label for="GST_No">GST No. / जीएसटी संख्या<font color="red">*</font></label>
                  <input type="text" class="form-control form-control-sm" name="GST_No" id="GST_No" placeholder="Enter GST No." maxlength="15" value="{{ !empty(trim(@$np_rate_renewal[0]->{'GST No_'})) ? @$np_rate_renewal[0]->{'GST No_'} : (@$vendor_datas->{'GST No_'} ? @$vendor_datas->{'GST No_'} : ' ') }}" {{$gst_readonly}} onchange="return checksum(this.value), checkGstUnique(this.value)" {{$renewal_readonly}}>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select name="cir_base" id="cir_base" class="form-control  form-control-sm" style="width: 100%;" {{ @$renewal_disabled }}>
                    <option value="0" {{ ( !empty(@$np_rate_renewal) && @$np_rate_renewal[0]->{'CIR Base'} == 0 )  ? 'selected' : ((@$vendor_datas->{'CIR Base'} == 0 && @$vendor_datas->{'CIR Base'} != "")  ? 'selected' : '') }}>RNI</option>
                    <option value="1" {{ @$np_rate_renewal[0]->{'CIR Base'} == 1  ? 'selected' : (@$vendor_datas->{'CIR Base'} == 1  ? 'selected' : '') }}>CA</option>
                    <option value="2" {{ @$np_rate_renewal[0]->{'CIR Base'} == 2  ? 'selected' : (@$vendor_datas->{'CIR Base'} == 2  ? 'selected' : '') }}>PIB</option>
                    <option value="3" {{ @$np_rate_renewal[0]->{'CIR Base'} == 3  ? 'selected' : (@$vendor_datas->{'CIR Base'} == 3  ? 'selected' : '') }}>ABC</option>
                  </select>
                  <input type="hidden" name="cir_base" id="cir_base_old" value="{{ @$np_rate_renewal[0]->{'CIR Base'} ?? @$vendor_datas->{'CIR Base'} ?? '' }}">
              ...
              <div class="col-md-4" id="rni_regist_no" style="display: {{$rni_regist_no}};">
                <div class="form-group">
                  ...
                  <input type="text" name="rni_registration_no" maxlength="25" placeholder="Enter RNI Registration No." class="form-control  form-control-sm" onkeyup="return checkRegCIRBase(this.value)" id="rni_registration_no" value="{{ $reg_no }}" {{ @$renewal_readonly }}>
              ...
              <div class="col-md-4" id="abc-certificate" style="display: {{$abc_cert}};">
                <div class="form-group">
                  ...
                  <input type="text" name="abc_certificate_no" maxlength="15" placeholder="Enter ABC Certificate No." class="form-control form-control-sm" onchange="return checkRegCIRBase(this.value)" id="abc_certificate_no" value="{{ @$np_rate_renewal[0]->{'ABC Certificate No_'} ?? $vendor_datas->{'ABC Number'} ?? ''}}" {{ $renewal_readonly }}>
            ...
            <div class="row">
              <div class="col-md-4" id="rni-efilling" style="display: {{$efiling}};">
                <div class="form-group">
                  ...
                  <input type="text" name="rni_efiling_no" maxlength="19" placeholder="Enter Rni E-filing Number" class="form-control  form-control-sm" id="rni_efiling_no" value="{{ @$np_rate_renewal[0]->{'RNI E-filling No_'} ?? $vendor_datas->{'RNI E-filling No_'} ?? '' }}" {{ @$renewal_readonly }}>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="email" class="form-control  form-control-sm" maxlength="40" id="v_email" name="v_email" placeholder="Enter Email ID" value="{{ @$np_rate_renewal[0]->{'E-mail ID'} !='' ? $np_rate_renewal[0]->{'E-mail ID'} : @$vendor_datas->{'E-mail ID'} }}" onchange="checkUniqueEmailVendor('email', this.value)" {{$renewal_readonly}}>
          ...
          <div id="tab4" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab4-trigger">
            ...
            <div class="row">
              ...
              <div class="col-md-6" id="no_dues_cert">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" name="no_dues_cert_file_name" id="no_dues_cert_file_name" accept="application/pdf">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <div class="icheck-success d-inline">
                  <input type="checkbox" name="advertisement_policy" id="advertisement_policy" {{ $policy_check }} {{ $renewal_disabled }}>
