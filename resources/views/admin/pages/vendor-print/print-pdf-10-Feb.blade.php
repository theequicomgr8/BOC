...
<body>
    <table width="100%" border="1" style="border-collapse: collapse;" cellspacing="0" cellpadding="5">
        <tr>
        ...
        <tr>
            <td style="background: #2268B2;" colspan="3">
                <h4 style="text-align: center; color: #fff;"><strong>Minimum Current Card Rate</strong></h4>
            </td>
        </tr>
        <tr>
            <td colspan="1">
