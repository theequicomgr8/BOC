...
<div class="content-inside p-3">
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-normal text-primary">Account Details</h6>
        </div>
        <!-- Card Body -->
        <div class="card-body">
            ...
            @if(Session::has('account_msg'))
              <div class="alert alert-success alert-dismissible">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                <strong>Success!</strong> {{ Session('account_msg') }}.
              </div>
            @endif
            ...
            <form method="POST" action="{{Route('account_detail')}}" autocomplete="off" id="account_detail_form">
                {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-4"><br><br><br>
                                <div class="form-group">
                                    ...
                                    <select class="form-control  form-control-sm" name="account_type" id="account_type">
                                        ...
                                        <option value="0" {{ (@$account_detail['Account Type'] == 0 && @$account_detail['Account Type'] != "" ? 'selected' : '') }}>Savings</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control  form-control-sm" name="ifsc_code" id="ifsc_code" maxlength="11" placeholder="Enter IFSC Code" value="{{ $account_detail['IFSC Code'] ?? old('ifsc_code') }}" onkeypress="return isAlphaNumeric(event,this);" onchange="validateIfscCode(this);">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pan_card" id="pan_card" class="form-control  form-control-sm" maxlength="10" placeholder="Enter Pan Card" value="{{ $account_detail['PAN'] ?? old('pan_card') }}" onkeypress="javascript:return isAlphaNumeric(event,this.value);" onchange="validatePanNumber(this)">
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary" style="margin-left: 13px;" {{ @$account_detail == '' ? 'disabled':'' }}>Save</button>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('custom_js')
<script src="{{ url('/js') }}/fresh-em-validation_accountdetails.js"></script>
@endsection