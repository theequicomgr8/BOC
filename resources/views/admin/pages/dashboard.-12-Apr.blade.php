...
<div class="content-inside p-3">
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="text-xs font-weight-bold mb-1"><a class="text-gray-800" href="{{ url('fresh-empanelment') }}"><i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="text-xs font-weight-bold mb-1"><a class="text-gray-800" href="{{ url('print-renewal') }}"> <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
                        </div>
                        <div class="col-auto">
                            <i class="fa fa-print fa-2x text-gray-300"></i>
                        </div>
        ...
        @elseif(Session::get('WingType')=='M003' && $user_id != 'EMRUY3')
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card c6 shadow h-100 py-2 hvr-pop">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold c6-txt text-uppercase mb-1 module-name"> Add Personal Media Empanelment</div>
                            <div class="text-xs font-weight-bold mb-1"><a class="text-gray-800" href="{{ url('personal-list') }}"> <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="text-xs font-weight-bold mb-1"><a class="text-gray-800" href="{{ url('personal-renewal') }}"> <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
                        </div>
                        <div class="col-auto">
                            <i class="fa fa-bullhorn fa-2x text-gray-300"></i>
                        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card c8 shadow h-100 py-2 hvr-pop">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold c8-txt text-uppercase mb-1 module-name"> Add Private Media Empanelment</div>
                            <div class="text-xs font-weight-bold mb-1"><a class="text-gray-800" href="{{ url('rate-settlement-private-media') }}"><i class="fa fa-user-plus" aria-hidden="true"></i></a></div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card c9 shadow h-100 py-2 hvr-pop">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold c9-txt text-uppercase mb-1 module-name"> Add Sole Right Media Empanelment</div>
                            <div class="text-xs font-weight-bold mb-1"><a class="text-gray-800" href="{{ url('sole-right-list') }}"><i class="fa fa-user-plus" aria-hidden="true"></i></a></div>
                        </div>
                        <div class="col-auto">
                            <i class="fa fa-user-plus fa-2x text-gray-300"></i>
                        </div>
        ...
        @elseif(Session::get('WingType')=='M002' && $user_id != 'EMRUY3')
        <div class="col-xl-3 col-md-6 mb-4">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card c11 shadow h-100 py-2 hvr-pop">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold c11-txt text-uppercase mb-1 module-name">Add ROB Activity </div>
            ...
            <div class="card c10 shadow h-100 py-2 hvr-pop">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold c10-txt text-uppercase mb-1 module-name">FOB Activity List</div>
                            <div class="text-xs font-weight-bold mb-1"><a class="text-gray-800" href="{{ url('fob-list') }}">See List <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
                        </div>
                        <div class="col-auto">
                            <i class="fa fa-list fa-2x text-gray-300"></i>
                        </div>
