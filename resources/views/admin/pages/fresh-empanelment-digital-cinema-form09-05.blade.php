                ...
                <div class="tab-content">
                    <div id="tab1" class="content pt-3 tab-pane active show" role="tabpanel"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="digital_mobile" id="owner_mobile" placeholder="Enter Mobile" onkeypress="return onlyNumberKey(event)" maxlength="10"
	                    ...
	                    <div class="col-md-4">
	                     ...
	                     <div class="col-md-4">
	                        <div class="form-group">
	                        <label for="district">District / ज़िला {{@$vendorData->{'District'} ?? ''}}<font color="red">*</font></label>
                  ...
                  <div id="tab2" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab1-trigger">
                    ...
                    @foreach($DigitalScreen_dTA as $DigitalSc)
                        <div class="row" id="add_davp">
                                <div class="col-md-4">
                                <div class="form-group">
                                <label for="agency_contract_details">Agency Contract Details / एजेंसी अनुबंध विवरण</label>
                                    <p><input type="text" name="agency_contract_details[]" placeholder="Enter Agency Contract Details" class="form-control form-control-sm" onkeypress="return onlyAlphabets(event,this)" maxlength="30"
                                      {{$readonly}} value="{{@$DigitalSc->{'Agency Contract Detail'} ?? ''}}"></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                       ...
                       @endforeach
                        @else
                         <div class="row" id="add_davp">
                                ...
                                <div class="form-group">
                                <label for="agency_contract_details">Agency Contract Details / एजेंसी अनुबंध विवरण</label>
                                    <p><input type="text" name="agency_contract_details[]" placeholder="Enter Agency Contract Details" class="form-control form-control-sm" onkeypress="return onlyAlphabets(event,this)" maxlength="30" {{$readonly}} value=""></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                    ...
                    <div id="tab3" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab1-trigger">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                         ...
                         <input type="text" name="PAN" id="pan_card" class="form-control form-control-sm" placeholder="Enter Pan card" maxlength="10" {{$readonly}} value="{{@$vendorData->{'PAN'} ?? ''}}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <span id="agreement_parties3" class="error invalid-feedback"></span>
                                </div>
                            </div>
...
$(document).ready(function(){
    $("#add_row").click(function(){
		$("#add_davp").append('<div class="row" style="margin: 0px !important;"><div class="col-md-4"><div class="form-group"><label for="agency_contract_details">Agency Contract Details / एजेंसी अनुबंध विवरण</label><p><input type="text" name="agency_contract_details[]" placeholder="Enter Agency Contract Details" class="form-control form-control-sm" maxlength="30"></p></div></div><div class="col-md-4"><div class="form-group"><label for="screen_unique_code">Screen Unique Code / स्क्रीन यूनिक कोड*</label><p><input type="text" name="screen_unique_code[]" placeholder="Enter Screen Unique Code" class="form-control form-control-sm" maxlength="30"></p></div></div><div class="col-md-4"><div class="form-group"><label for="number_screens">Number of Seats / सीटों की संख्या*</label><p><input type="text" name="number_screens[]" placeholder="Enter Number of Seats" class="form-control form-control-sm" onkeypress="return onlyNumberKey(event)" maxlength="8"></p></div></div><div class="col-md-10"></div><div class="col-md-2" style="padding-left: 60px;"><button class="btn btn-danger remove_row mr-1">Remove</button></div></div>');
	});
