     ...
     <thead>
      ...
      <table class="table table-striped table-bordered table-hover order-list" id="myTable" width="100%">   
        ...
        <tr>
                        ...
                        <td width="245px">{{@$mhead->{'Ministries Head'} ?? ''}}, ({{@$dbresponse->ministry_name ?? 'N/A'}}) <br /> {{@$mhead->{'Head Name'} ?? ''}}</td>
                        <td><strong>Officer Name</strong></td>
                        <td width="10px"><strong>:</strong></td>
                        <td width="245px">{{@$crh->{'Requesting officer Name'} ?? 'N/A' }}</td>
                    </tr>
                    <tr>
                        <td><strong>Designation</strong></td>
                        <td><strong>:</strong></td>
                        <td>{{@$crh->{'Designation'} ?? 'N/A' }}</td>
                        <td><strong>E-Mail Id </strong></td>
                        <td><strong>:</strong></td>
                        <td>{{@$crh->{'Email Id'} ?? 'N/A' }}</td>
                    </tr>
                    <tr>
                        <td><strong>Govt E-mail ID</strong></td>
                        <td><strong>:</strong></td>
                        <td>{{@$crh->{'Govt E-mail ID'} ?? 'N/A' }}</td>
                        <td><strong>Mobile No</strong></td>
                        <td><strong>:</strong></td>
                        <td>{{@$crh->{'Mobile No_'} ?? 'N/A' }}</td>
                    </tr>
                    <tr>
                        <td><strong>Phone No(with STD code)</strong></td>
                        <td><strong>:</strong></td>
                        <td>{{@$crh->{'Phone No_'} ?? 'N/A'}}</td>
                        <td><strong>Address</strong></td>
                        <td><strong>:</strong></td>
                        <td>{{@$crh->Address ?? 'N/A'}}</td>
                    </tr>
                    <tr>
                        <td><strong>Department file. Ref. No.</strong></td>
                        <td><strong>:</strong></td>
                        <td>{{ $crh->{'Client Refrence No_'} ?? 'N/A' }}</td>
        ...
        <tr>  
           ...
           <td><strong>Budget</strong></td>
                    <td><strong>:</strong></td>
                    <td >{{ round(@$prch->{'Print Budget'}) && round(@$prch->{'Print Budget'})!=0? round(@$prch->{'Print Budget'}):'N/A' }}</td>
           <td><strong>Target area</strong></td>
            ...
            <td><strong>Random cities</strong></td>
                    <td><strong>:</strong></td>
                    <td> @foreach($allCityData as $allCity)
            ...
            <td><strong>Requirement(s)</strong></td>
                    <td><strong>:</strong></td>
                    <td >{{ @$prch->{'Requirement'}?? 'N/A'}}</td>
            <td><strong>Remarks for revision</strong></td>
                    <td><strong>:</strong></td>
                    <td >{{ @$prch->{'Remarks'} ?? 'N/A'}}</td>
             </tr>
        <tr>
...
<td><strong></strong></td>
        <td><strong>:</strong></td>
        <td colspan="4" width="500px"> N/A</td>
@else
<td><strong></strong></td>
        <td><strong>:</strong></td>
        <td colspan="4" width="500px"> N/A</td>
...
<tr>
    <td><strong>Requirements</strong></td>
        <td><strong>:</strong></td>
        <td colspan="4">{{@$codm[0]->{'Requirement'} ?? 'N/A'}}</td>
 </tr>
<tr>
<td><strong>Uploaded creative</strong></td>
        <td><strong>:</strong></td>
    ...
    <tr>
        ...
        @endif
            <td><strong>Duration(in seconds)</strong></td>
                <td><strong>:</strong></td>
               <td >{{@$tvcr->{'Duration'} ?? 'N/A'}}</td>
        </tr>
        <tr>
            <td><strong>Spots No.</strong></td>
                <td><strong>:</strong></td>
               <td >{{@$tvcr->{'Spot Per Day'} ?? 'N/A'}}</td>
        ...
        <tr>
            <td><strong>Requirement(s) (1000 characters max)</strong></td>
                <td><strong>:</strong></td>
               <td >{{@$tvcr->{'Requirement'} ?? 'N/A'}}</td>
            <td><strong>Remarks (100 characters max)</strong></td>
                <td><strong>:</strong></td>
               <td >{{@$tvcr->{'Remarks'} ?? 'N/A'}}</td>
        </tr>
        <tr>
...
@if(@$crh->{'AV - Radio'} == 0)
    ...
    <tr>
        ...
        @if(@$crsRadiocr->{'Target Area'} == "1" && @$crsRadiocr->{'Target Area'} != "")
            <td><strong>Specific Regional</strong></td>
                <td><strong>:</strong></td>
                <td> @foreach($regionalLang as $regionLang)
