...
@section('content')
 ...
 <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
         <div class="row">
          <div class="col-md-12" style="flex: 0 0 103%;
    max-width: 103%;">
            ...
            <div class="card-header">
              ...
              <p><STRONG style="color: #0072C6;">PRINT MEDIA PLAN - {{$mpdetail->{'MP No_'} }}</STRONG>
               <a href="{{url('media-plan-viewPDF/'.$mpdetail->{'MP No_'}.'/'.$mpdetail->{'Version'} )}}" class="m-0 font-weight-normal text-primary float-right"> <i class="fa fa-download"></i> Download Media Plan Request</a></p>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                    ...
                    <label class="control-label col-sm-3 font-weight-normal">{{ $mpdetail->{'Client Name'} }}</label>
                  ...
                  <div class="row">
                    ...
                    <label class="control-label col-sm-3">Color Type</label>
                     @if($mpdetail->Color == 0)      
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-6 offset-sm-5">
                     <a class="btn btn-primary " onclick='SaveComment("{{ @$mpdetail->{"MP No_"} }}");' >Send to Boc</a>
