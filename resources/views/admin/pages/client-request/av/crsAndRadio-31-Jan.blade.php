  <div class="row">
    ...
    <div class="form-group">
      ...
      <select {{ $disabled }} name="crsRadioMedium" id="crsRadioMedium" class="form-control form-control-sm">
        ...
        <option value="0"{{@$crsRadiocr->{'Radio Type'} ==0 && @$crsRadiocr->{'Radio Type'} != ""  ? 'selected' : ''}} >PVT. FM / प्राइवेट. एफएम</option>
        <option value="1" {{@$crsRadiocr->{'Radio Type'} ==1 && @$crsRadiocr->{'Radio Type'} != ""  ? 'selected' : ''}}>CRS / सीआरएस</option>
      </select>
    </div>
  </div>
    <div class="col-md-4">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
        <label class="form-control-label">No. Of Spots <font color="red">*</font>
        </label>
  ...
  <div class="row">
    ...
    <div class="col-md-4" id="crsRadioUploadCreativeDiv">
      <div class="form-group">
        ...
        <input {{ $disabled }} type="file" accept="jpg,png" class="form-control form-control-sm" name="crsRadioCreativeFileName" id="crsRadioCreativeFileName" ><span id="upload_doc_error" class="error invalid-feedback"></span>
      </div>
    </div>
    @endif
    @if(@$crsRadiocr->{'Creative File Name'}!='' || @$crsRadiocr->{'Creative File Name'}!=null)
    <div class="col-md-4" id="crsRadioUploadCreativeDiv">
      <div class="form-group">
        ...
        <a href="{{ url('/uploads') }}/client-request/{{ $crsRadiocr->{'Creative File Name'} }}" target="_blanck"><img src="{{ url('/uploads') }}/client-request/{{ $crsRadiocr->{'Creative File Name'} }}" width="80px" height="80px"></a></span>
      </div>
    </div>
    @endif
  </div>
