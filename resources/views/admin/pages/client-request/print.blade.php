...
<div class="row">
  ...
  <div class="col-md-4">
    <div class="form-group">
      ...
      <select {{ $disabled }} name="print_media_planType" id="media_plan" class="form-control form-control-sm" onchange="getMediaType(this.value)">
        ...
        <option value="2" {{@$prch->{'Media Plan Type'} == 2 && @$prch->{'Media Plan Type'} != ""  ? 'selected' : ''}}>Employment News</option>
      </select>
  ...
  <div class="col-md-4" id="print_size_select">
    <div class="form-group">
      <label class="form-control-label">Print size selection<font color="red">*</font></label>
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="form-group" id="group_state">
        <label class="form-control-label">Group of states <font color="red">*</font></label>
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="form-group" id="individuals_state">
        <label class="form-control-label">Individual state <font color="red">*</font></label>
...
<div class="row">
  ...
  <div class="col-md-4">
    <div class="form-group" id="languageName">
      <label class="form-control-label">Language(S/M)<font color="red">*</font></label>
  ...
  <div class="col-md-4" id="single_langauge_select_div">
    <div class="form-group">
      <label class="form-control-label">Single language<font color="red">*</font></label>
  ...
  <div class="col-md-4" id="multi_langauge_select_div">
    <div class="form-group">
      <label class="form-control-label">Multiple language <font color="red">*</font></label>
  ...
  <div class="col-md-4" id="selecte_hindi_english">
    <div class="form-group">
      <label class="form-control-label">Language Hindi & English <font color="red">*</font> </label>
  ...
  <div class="col-md-4" id="demography">
    <div class="form-group">
      <label class="form-control-label">Demography</label>
