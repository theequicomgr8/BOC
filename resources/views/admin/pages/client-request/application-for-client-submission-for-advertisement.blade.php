...
<div class="content-inside p-3">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 text-primary"><i class="fa fa-edit"></i> Application for client submission for advertisement</h6>
        ...
        <div class="tab-content">
          <div class="tab-pane content pt-3 mcontenttab show active" id="BasicInformation-tab" role="tabpanel" aria-labelledby="BasicInformation-tab">
            ...
            <div class="row">
               <div class="col-md-4">
                <div class="form-group">
                  <label class="form-control-label">Ministry Head/मंत्रालय प्रमुख</label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input {{ $disabled }} name="Name_of_Officer" id="Name_of_Officer" placeholder="Enter Name of Officer " maxlength="40" minlength="3" class="form-control form-control-sm" onkeypress="return onlyAlphabets(event,this)" value="{{ $crh->{'Requesting officer Name'} ?? '' }}">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input {{ $disabled }} name="Designation" id="Designation" placeholder="Enter Designation " class="form-control form-control-sm" minlength="2" maxlength="40" onkeypress="return onlyAlphabets(event,this)" value="{{ $crh->{'Designation'} ?? '' }}">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input {{ $disabled }} type="email" class="form-control form-control-sm" maxlength="40" name="email" id="email" placeholder="Enter email" value="{{ $crh->{'Email Id'} ?? @$email ?? '' }}">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input {{ $disabled }} type="email" class="form-control form-control-sm" maxlength="40" name="govt_email_id" id="govt_email_id" placeholder="Enter Govt email" value="{{ $crh->{'Govt E-mail ID'} ?? '' }}">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label class="form-control-label">Mobile No./मोबाइल नंबर<span style="color:red">*</span></label>
                  <input {{ $disabled  }} type="text" class="form-control form-control-sm" name="mobile" placeholder="Enter mobile no." onkeypress="return onlyNumberKey(event)" maxlength="10" value="{{ $crh->{'Mobile No_'} ?? '' }}">
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <textarea {{ $disabled }} name="address" id="address" placeholder="Enter Address" rows="2" cols="50" minlength="2" maxlength="120" class="form-control form-control-sm">{{$crh->Address??''}}</textarea>
    ...
    $.ajax({
      ...
      success: function(data) {
        if (data.success == true) {
          var $message = tab + ' data successfully saved';
          $("#app").scrollTop(0);
