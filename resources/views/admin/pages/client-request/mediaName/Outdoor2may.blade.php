<?php //echo"<pre>";print_r($codm);die; ?>
 <div class="row">
    ...
    <div class="form-group">
      ...
      <input {{ $disabled }} style="{{$style}}" type="text" class="form-control form-control-sm" name="outdoorfrom_date" id="outdoorfrom_date" value="{{ date('d-m-Y',strtotime(@$codm[0]->{'From Date'})) && date('d-m-Y',strtotime(@$codm[0]->{'From Date'}))!='01-01-1970'  ? date('d-m-Y',strtotime(@$codm[0]->{'From Date'})) : '' }}" placeholder="DD/MM/YYYY" autocomplete="off">
  ...
  <div class="col-md-4">
    <div class="form-group">
      ...
      <input {{ $disabled }} style={{ $style }} type="text" class="form-control form-control-sm" name="outdoorto_date" id="outdoorto_date" value="{{ date('d-m-Y',strtotime(@$codm[0]->{'To Date'})) && date('d-m-Y',strtotime(@$codm[0]->{'To Date'}))!='01-01-1970' ?date('d-m-Y',strtotime(@$codm[0]->{'To Date'})): ''}}" placeholder="DD/MM/YYYY" autocomplete="off">
      <span id="date_error" style="color:red;display: none;"></span>
    </div>
  </div>
</div>
<div class="row">
  ...
  <div class="col-md-4">
    <div class="form-group">
      ...
      <input {{ $disabled }} type="text" class="form-control form-control-sm" name="outdoortentative_budget" maxlength="20" id="outdoortentative_budget" placeholder="Enter Tentative Budget." onkeypress="return onlyNumberKey(event)" value="{{round(@$codm[0]->{'OD Budget'}) && round(@$codm[0]->{'OD Budget'})!=0 ? round(@$codm[0]->{'OD Budget'}) :''}}">
    </div>
  </div><!--------end Tentative--------->
</div>
<?php $addmorekey=0; ?>
  ...
  <legend><i class="fa fa-file-text-o"></i> Media Details</legend>
    ...
    <div class="col-md-4" >
      <div class="form-group">
        ...
        <input {{ $disabled }} readonly="readonly" type="text"  name="outdoorAdvArea[]" id="outdoorAdvArea0" placeholder="Advertise Area(Sq Cm)" class="form-control form-control-sm" onkeypress="return isNumber(event)" value="{{round(@$codmDetail->{'Advt_ Area'}) && round(@$codmDetail->{'Advt_ Area'})!=0 ?round(@$codmDetail->{'Advt_ Area'}):  ''}}" >
      </div>
    </div> 
  </div>-->
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <select {{ $disabled }} name="outdoorMediaCategory[]" id="outdoorMediaCategory{{$addmorekey}}" class="form-control form-control-sm">
    ...
    <div class="col-md-4">
      <div class="form-group">
        <label class="form-control-label">Media subcategory/मीडिया उपश्रेणी<span style="color:red">*</span></label>
        <select {{ $disabled }} name="outdoorMediaSubCategory[]" id="outdoorMediaSubCategory{{$addmorekey}}" class="form-control form-control-sm">
         
        </select>
      </div>
    </div><!--------end Media Sub Category--------->
    <!-- start  train list dropdown     --->
    <div class="col-md-4 " id="divOutdoor_train{{$addmorekey}}" style="display: none;">
      <div class="form-group">
        <label class="form-control-label">Train No/ट्रेन संख्या<span style="color:red">*</span></label>
        <select {{ $disabled }} name="outdoortrain[]" id="outdoortrain{{$addmorekey}}" class="form-control form-control-sm">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <select {{ $disabled }} name="outdoorTArea[]" id="outdoorTArea{{$addmorekey}}" class="form-control form-control-sm">
  ...
  <div class="row">
    ...
    <div class="col-md-4 selectedTgroup0" id="divOutdoor_CityTown{{$addmorekey}}" style="display: none;">
      <div class="form-group">
        <label class="form-control-label">City/Town/शहर/कस्बा<span style="color:red">*</span></label>
         <select {{$disabled}} name="outdoorTown[]" id="outdoorTown{{$addmorekey}}" class="form-control form-control-sm" >
    ...
    <div class="col-md-4 selectedTgroup{{$addmorekey}}" id="divOutdoor_GroupStates{{$addmorekey}}" style="display: none;">
      <div class="form-group" >
       <label class="form-control-label">Group of states/राज्यों का समूह <span style="color:red">*</span></label>
        <select {{$disabled}} name="outdoorGroupState[0][]" id="outdoorGroupState{{$addmorekey}}" class="form-control form-control-sm" multiple>
    ...
    <div class="col-md-4 selectedTgroup{{$addmorekey}}" id="divOutdoor_GroupCity{{$addmorekey}}" style="display: none;">
      <div class="form-group">
        ...
        <select {{ $disabled }} name="outdoorGroupCity[]" id="outdoorGroupCity{{$addmorekey}}" class="form-control form-control-sm">
          <option value="">Select </option>
    ...
    <div class="col-md-4 selectedTgroupCity{{$addmorekey}}" id="divOutdoor_RandomCity{{$addmorekey}}" style="display: none;">
      <div class="form-group">
        ...
        <select {{ $disabled }} name="outdoorRandomCityList[0][]" id="outdoorRandomCityList{{$addmorekey}}" class="form-control form-control-sm" multiple>
         @foreach($allCityData as $allCity)
  ...
  <div class="row" >
    <div class="col-md-4 selectedTgroup{{$addmorekey}}" id="divOutdoor_IndividualState{{$addmorekey}}"style="display: none;" >
      <div class="form-group" id="outdoor_individual_state" >
        ...
        <select {{ $disabled }} name="outdoorIndividualState[]" id="outdoorIndividualState{{$addmorekey}}" class="form-control form-control-sm">
    ...
    <div class="col-md-4 selectedTgroup{{$addmorekey}}" id="outdoorgetCityDiv{{$addmorekey}}" style="display: none;">
      <div class="form-group">
        ...
        <select {{ $disabled }} name="outdoorCityList[]" id="outdoorCityList{{$addmorekey}}" class="form-control form-control-sm">
    ...
    <div class="col-md-4" id="spotnoDiv{{$addmorekey}}" style="display: none;">
      <div class="form-group">
        ...
        <input {{ $disabled }} type="text" maxlength="20" name="outdoorSpotsno[]" id="outdoorSpotsno{{$addmorekey}}" placeholder="Enter Spots No." class="form-control form-control-sm" value="{{@$codmDetail->{'No_ Of Spots'} ?? ''}}" onkeypress="return isNumber(event)">
      </div>
    </div>
  </div>
 <!--  <div class="row">
