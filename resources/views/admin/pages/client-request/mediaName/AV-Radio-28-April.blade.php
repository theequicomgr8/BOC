<div class="row">
    ...
    <div class="form-group">
      ...
      <input {{ $disabled }} style="{{$style}}" type="text" class="form-control form-control-sm" name="crsRadiofrom_date" id="crsRadiofrom_date" value="{{ date('d-m-Y',strtotime(@$crsRadiocr->{'From Date'})) && date('d-m-Y',strtotime(@$crsRadiocr->{'From Date'}))!='01-01-1970' ?date('d-m-Y',strtotime(@$crsRadiocr->{'From Date'})): '' }}" placeholder="DD/MM/YYYY" autocomplete="off">
  ...
  <div class="col-md-4">
    <div class="form-group">
      ...
      <input {{ $disabled }} style={{ $style }} type="text" class="form-control form-control-sm" name="crsRadioto_date" id="crsRadioto_date" value="{{ date('d-m-Y',strtotime(@$crsRadiocr->{'To Date'})) && date('d-m-Y',strtotime(@$crsRadiocr->{'To Date'}))!='01-01-1970' ?date('d-m-Y',strtotime(@$crsRadiocr->{'To Date'})): '' }}" placeholder="DD/MM/YYYY" autocomplete="off">
      <span id="date_error" style="color:red;display: none;"></span>
    </div>
  </div>
</div>
  ...
  <div class="col-md-4">
    ...
    <div class="col-md-4" id="crsRadioSpecificRegionDiv" style="display: none;">
      <div class="form-group">
        <label class="form-control-label">Specific Regional / क्षेत्रों का समूह <span style="color:red">*</span>
        </label>
     ...
     <div class="col-md-4">
      <div class="form-group">
        ...
        <select {{ $disabled }} name="crsRadioCreativeAvail" id="crsRadioCreativeAvail" class="form-control form-control-sm" >
          ...
          <!-- <option value="2" {{@$crsRadiocr->{'Creative Available'} == 2 && @$crsRadiocr->{'Creative Available'} != ""  ? 'selected' : ''}}>Creative to be developed by BOC</option>
