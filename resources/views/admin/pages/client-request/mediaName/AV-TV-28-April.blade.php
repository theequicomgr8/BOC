<div class="row">
    ...
    <div class="form-group">
      ...
      <input {{ $disabled }} style="{{$style}}" type="text" class="form-control form-control-sm" name="tvfrom_date" id="tvfrom_date" value="{{ date('d-m-Y',strtotime(@$tvcr->{'From Date'})) && date('d-m-Y',strtotime(@$tvcr->{'From Date'}))!='01-01-1970' ? date('d-m-Y',strtotime(@$tvcr->{'From Date'})) :'' }}" placeholder="DD/MM/YYYY" autocomplete="off">
  ...
  <div class="col-md-4">
    <div class="form-group">
      ...
      <input {{ $disabled }} style={{ $style }} type="text" class="form-control form-control-sm" name="tvto_date" id="tvto_date" value="{{ date('d-m-Y',strtotime(@$tvcr->{'To Date'})) && date('d-m-Y',strtotime(@$tvcr->{'To Date'}))!='01-01-1970' ? date('d-m-Y',strtotime(@$tvcr->{'To Date'})):'' }}" placeholder="DD/MM/YYYY" autocomplete="off">
      <span id="date_error" style="color:red;display: none;"></span>
    </div>
  </div>
</div>
