<div class="row">
  ...
  <div class="col-md-4">
    <div class="form-group">
      ...
      <input {{ $disabled }} type="text" class="form-control form-control-sm {{$disabled=='disabled' ? 'remove-arrow-select':'' }}" name="tvTentative_budget" maxlength="20" id="tvTentative_budget" placeholder="Enter Tentative Budget." onkeypress="return onlyNumberKey(event)" value="{{round(@$tvcr->{'Allocated Budget'}) && round(@$tvcr->{'Allocated Budget'})!=0 ? round(@$tvcr->{'Allocated Budget'}) :''}}">
    </div>
  </div><!--------end Tentative--------->
    <div class="col-md-4" id="tvSpecificRegionDiv" style="display: none;">
      <div class="form-group">
        ...
        <select {{$disabled}} name="tvRegion[]" id="tvSpecificRegion"  class="form-control form-control-sm {{$disabled=='disabled' ? 'remove-arrow-select':'' }}">
