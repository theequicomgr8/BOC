  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <select {{ $disabled }} name="outdoorMediaCategory[]" id="outdoorMediaCategory{{$addmorekey}}" class="form-control form-control-sm {{$disabled=='disabled' ? 'remove-arrow-select':'' }}">
...
<div class="row">
  ...
  <div class="col-md-4" id="outdoorUploadCreativeDiv">
    <div class="form-group">
      ...
      <input {{ $disabled }} type="file" accept="image/png, image/jpeg, image/jpg" class="form-control form-control-sm {{$disabled=='disabled' ? 'remove-arrow-select':'' }}" name="outdoorCreativeFileName" id="outdoorCreativeFileName" ><span id="upload_doc_error" class="error invalid-feedback"></span>
    </div>
  </div>
  @endif
  @if(@$codm[0]->{'Creative File Name'}!='' || @$codm[0]->{'Creative File Name'}!=null)
  ...
  <div class="col-md-4">
    <div class="form-group">
      ...
      <select {{ $disabled }} name="outdoorLanguage" id="outdoorLanguage" class="form-control form-control-sm {{$disabled=='disabled' ? 'remove-arrow-select':'' }}">
