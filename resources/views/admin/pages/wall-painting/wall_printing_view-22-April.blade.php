  ...
  text-align: center;
   ...
   <body>
      <div class="container pt-4 canvas_div_pdf">
         <h4 class="text-left" style="text-align: center;"><u>Evaluation of technical bid for wall painting / Digital wall painting</u> <a href="{{ url('wallPainting-export-pdf/'.Request::segment(2)) }}" id="download" style="background:#006799; color:#fff; text-decoration:none; font-size:16px; border-radius: 15px; font-family: sans-serif; padding:8px 20px; text-transform: uppercase;">Download</a></h4><br>

         <p style="margin-left: 10%;">A. Detail of company
            <a href="{{URL::to('wallPainting')}}" title="Home" class="pull-right" style="margin-left: 74%;">
                Back
            </a>
        </p>
         @if(session('msg'))
