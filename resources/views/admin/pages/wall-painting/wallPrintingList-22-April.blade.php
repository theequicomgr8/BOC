...
<div class="content-inside p-3">
    <link rel="stylesheet" type="text/css" href="//cdn.datatables.net/1.11.4/css/jquery.dataTables.min.css">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <a href="/bocfront/wall-painting" class="btn btn-info" style="float: right;"><i class="fa fa-plus"></i> Add Wall Painting</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                            ...
                            <tbody>
                                ...
                                @foreach ($vendor as $key => $vendors)
                                    <tr>
                                        ...
                                        <td>{{ $vendors->head_office_telphone_email }}</td>
                                        <td>{{ $vendors->branch_telephone }}</td>
                                        <td>
                                            <a href="{{URL::to('wallPainting-view')}}/{{$vendors->id}}" title="View Details" style="text-decoration: none;color: blue;" id="view"><i class="fa fa-eye"></i> View</a>
                                        </td>
                                    </tr>
                                @php
                                $i++;
