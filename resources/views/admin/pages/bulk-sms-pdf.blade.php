            ...
            <table class="table table-striped table-bordered table-hover order-list text-size" id="myTable" width="100%"> 
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td><strong>:</strong></td>
                        <td>{{ @$Bluksms->{'ESI A_C No_'} ?? ''}}</td>
                        <td><strong>No of Employees Covered</strong></td>
                        <td><strong>:</strong></td>
                        <td>@if(@$Bluksms->{'No_ Of Emp in ESI'} >0){{@$Bluksms->{'No_ Of Emp in ESI'} ?? ''}}@endif</td>
                    </tr>
                    <tr>
                        <td><strong>Account No.</strong></td>
                        <td><strong>:</strong></td>
                        <td>{{@$Bluksms->{'EPF A_c No_'} ?? ''}}</td>
                        <td><strong>No of Employees Covered</strong></td>
                        <td><strong>:</strong></td>
                        <td>@if(@$Bluksms->{'No_ Of Emp in EPF'} > 0){{@$Bluksms->{'No_ Of Emp in EPF'} ?? ''}}@endif</td>
                    </tr>
                <tr>
                ...
                own for dissemination of information. It should provide the necessary proof in this regard </strong></td>
                    ...
                    <tr>
                        ...
                        <td width="3%"><strong>:</strong></td>
                        <td>{{@$Bluksms->{'PAN Upload File Name'} != '' ? 'Yes' : 'No'}}</td>
                        <td><strong>Certificate of incorporation in India</strong></td>
                        <td><strong>:</strong></td>
                        <td>{{ $Bluksms->{'GST Upload File Name'} != '' ? 'Yes' : 'No'}}</td>
                    </tr>
                </table>
                </div>
                </div>
