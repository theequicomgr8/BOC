...
@section('content')
            ...
            <!-- /.end card-header -->
                ...
                @foreach($owner_data as $ownerlist)                                
                    ...
                    <a class="btn btn-primary set-pm-next-button" id="tab_1">Next</a>
                  ...
                  <div id="tab2" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab1-trigger">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        <label for="address">Address / पता<font color="red">*</font></label>
                           <textarea {{$disabled}} type="text" name="HO_Address" id="HO_Address" placeholder="Enter Address" rows="1" class="form-control" maxlength="120">{{$vendor_data[0]['HO Address']?? ''}}</textarea>
                      ...
                      <div class="form-group">
                        ...
                        <input {{$disabled}} type="text" name="HO_Landline_No" id="landline_no" placeholder="Enter Landline No." class="form-control" onkeypress="return onlyNumberKey(event)" maxlength="14" value="{{$vendor_data[0]['HO Landline No_']?? ''}}">
                      ...
                      <input {{$disabled}} type="text" name="HO_Fax_No" placeholder="Enter Fax No" class="form-control" id="fax_no" onkeypress="return onlyNumberKey(event)" maxlength="14" value="{{$vendor_data[0]['HO Fax No_']?? ''}}">
                      ...
                      <input {{$disabled}} type="text" name="HO_Email" placeholder="Enter E-mail" class="form-control" id="HO_Email" value="{{$vendor_data[0]['HO E-Mail']?? ''}}" maxlength="50" onkeyup="return checkUniqueVendor('email', this.value)">
                      ...
                      <input {{$disabled}} type="text" class="form-control" id="HO_Mobile_No" name="HO_Mobile_No" placeholder="Enter Mobile" onkeypress="return onlyNumberKey(event)" maxlength="10" value="{{$vendor_data[0]['HO Mobile No_']?? ''}}" onkeyup="return checkUniqueVendor('mobile', this.value)">
                      ...
                      <div class="form-group">
                        ...
                        <textarea {{$disabled}} type="text" name="BO_Address" maxlength="120" placeholder="Enter Address" rows="1" class="form-control">{{$vendor_data[0]['BO Address']?? ''}}</textarea>
                      ...
                      <div class="form-group">
                        ...
                        <input {{$disabled}} type="text" name="BO_Landline_No" placeholder="Enter Landline No." class="form-control" id="landline_no" maxlength="14" onkeypress="return onlyNumberKey(event)" value="{{$vendor_data[0]['BO Landline No_']?? ''}}">
                      ...
                      <input {{$disabled}} type="text" name="BO_Fax_No" placeholder="Enter Fax No." class="form-control" id="fax_no" maxlength="14" onkeypress="return onlyNumberKey(event)" value="{{$vendor_data[0]['BO Fax No_']?? ''}}">
                      ...
                      <input {{$disabled}} type="text" name="BO_Email" placeholder="Enter E-mail" class="form-control" id="email" maxlength="30" value="{{$vendor_data[0]['BO E-Mail']?? ''}}">
                      ...
                      <input {{$disabled}} type="text" name="BO_Mobile" placeholder="Enter Mobile" class="form-control" id="mobile" onkeypress="return onlyNumberKey(event)" maxlength="10" value="{{$vendor_data[0]['BO Mobile No_']?? ''}}">
                    ...
                    <div class="row col-md-12"><h5>Delhi Office (if any) :-</h5></div><br>
                      ...
                      <div class="form-group">
                        <label for="DO_Address">Address / पता<font color="red">*</font></label>
                           <textarea {{$disabled}} type="text" name="DO_Address" id="DO_Address" placeholder="Enter Address" rows="1" class="form-control" maxlength="100">{{$vendor_data[0]['DO Address']?? ''}}</textarea>
                      ...
                      <div class="form-group">
                        ...
                        <input {{$disabled}} type="text" name="DO_Landline_No" placeholder="Enter Landline No." class="form-control" id="DO_Landline_No" onkeypress="return onlyNumberKey(event)" maxlength="15" value="{{$vendor_data[0]['DO Landline No_'] ?? ''}}">
                      ...
                      <label for="DO_Fax_No">Fax No. / फ़ैक्स  नंबर<font color="red">*</font></label>
                        <input {{$disabled}} type="text" name="DO_Fax_No" placeholder="Enter Fax No." class="form-control" id="DO_Fax_No" onkeypress="return onlyNumberKey(event)" maxlength="`5" value="{{$vendor_data[0]['DO Fax No_']?? ''}}">
                      ...
                      <div class="form-group">
                        ...
                        <input {{$disabled}} type="text" name="DO_Email" placeholder="Enter E-mail" class="form-control" id="DO_Email" value="{{$vendor_data[0]['DO E-Mail']?? ''}}">
                      ...
                      <label for="DO_Mobile">Mobile / मोबाइल<font color="red">*</font></label>
                         <input {{$disabled}} type="text" name="DO_Mobile" placeholder="Enter Mobile" class="form-control" id="DO_Mobile" onkeypress="return onlyNumberKey(event)" maxlength="15" value="{{$vendor_data[0]['DO Mobile No_']?? ''}}">
                      ...
                      <div class="col-md-4">
                        ...
                        <label>Legal Status Of Company / कंपनी की कानूनी स्थिति<font color="red">*</font></label>
                            <select {{$disabled}} name="Legal_Status_of_Company" id="Legal_Status_of_Company" class="form-control" style="width: 100%;" >
                      ...
                      <div class="col-md-4">
                        ...
                        <label for="relevant_information">Any Other Relevant Information / कोई अन्य प्रासंगिक जानकारी<font color="red">*</font></label>
                           <input {{$disabled}} type="text" name="Other_Relevant_Information" placeholder="Enter Any Other Relevant Information" class="form-control" id="Other_Relevant_Information" value="{{$vendor_data[0]['Other Relevant Information']?? ''}}">
                    ...
                    <div class="row col-md-12">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="Authority_Which_granted_Media" placeholder="Enter Authority Which Granted Media With Address" class="form-control" id="Authority_Which_granted_Media" value="{{$vendor_data[0]['Authority Which granted Media']?? ''}}" {{$disabled}}>
                        </div>
                      </div>
                      <div class="col-md-4">
                      <div class="form-group">
                      <label for="Amount_paid_to_Authority">Amount Paid to Authority For The Current Year / चालू वर्ष के लिए प्राधिकरण को भुगतान की गई राशि</label>
                        <input type="text" name="Amount_paid_to_Authority" placeholder="Enter Amount Paid to Authority For The Current Year" class="form-control" id="fax_no4" onkeypress="return onlyNumberKey(event)" value="{{$vendor_data[0]['Amount paid to Authority']?? ''}}" {{$disabled}}>
                      ...
                      <div class="col-md-4">
                        ...
                        <label>Select Type / प्रकार चुनें</label>
                            <select {{$disabled}} name="Media_Type" class="form-control" style="width: 100%;" id="select_type">
                      ...
                      <div class="col-md-4">
                        ...
                        <label>Rental Type / किराये का प्रकार</label>
                            <select {{$disabled}} name="rental_type" class="form-control" style="width: 100%;" id="rental_type">
                 ...
                 <div class="row" style="float:right;margin-top: 6px;">
                    <button class="btn btn-primary" id="add_row_next">Add</button>                  
                  </div><br><br>    
                  ...
                  <div class="row">
                      ...
                      <a class="btn btn-primary set-pm-next-button" id="tab_2">Next</a>
                      <!-- <a class="btn btn-primary" onclick="stepper.next()">Next</a> -->
                    </div> 
                    <div id="tab3" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab1-trigger">
                        ...
                        <a class="btn btn-primary reg-previous-button">Previous</a>
                        <a class="btn btn-primary set-pm-next-button" id="tab_3">Next</a>
                    </div>
