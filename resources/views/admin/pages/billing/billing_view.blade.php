  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <div class="col-xl-6">
        ...
        <a href="{{route('billing.billingPDF',['NPCode'=>$results->{'NP Code'},'ROCode'=>$results->{'RO No_'},'BillingStatus' => '1'])}}" class="btn btn-info" style="float: right;font-size: 13px;" download><i class="fa fa-download"></i> Download Reports</a>
        @endif
      </div>
    </div>
    <!-- Card Body -->
                ...
                <div class="col-md-6" >
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="ds" id="1" value="<?= $results->{'Vendor Bill Date'} ?>" readonly>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="ds" id="1" value="<?= $results->{'Publishing Date'}?>" readonly>
