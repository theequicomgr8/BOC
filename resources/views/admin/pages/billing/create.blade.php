        ...
        <div class="tab-content">
          <div id="logins-part" class="tab-pane active show">
            <div id="logins-part" class="content pt-3" role="tabpanel" aria-labelledby="logins-part-trigger">
              ...
              <input type="hidden" name="img1" value="{{ asset('uploads/client-request/'.$_GET['CrativeFileName'])}}" id="img1">
              <input type="hidden" name="img1_name" value="{{$_GET['CrativeFileName']}}" id="img1_name">
              ...
              <div class="row">
                ...
                <div class="col-md-4" >
                  <div class="form-group">
                    ...
                    <input  accept="image/png, image/jpeg, image/jpg" type="file" class="custom-file-doc form-control form-control-sm" name="npImage" id="npImage">
