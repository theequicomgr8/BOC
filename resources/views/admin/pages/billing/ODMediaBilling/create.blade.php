...
<div class="content-inside p-3">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 text-primary"><i class="fa fa-edit"></i>Bill Submission For Outdoor </h6>
    </div>
    <!-- Card Body -->
    <div class="card-body">
        ...
        <div class="tab-content">
          <div id="logins-part" class="tab-pane active show">
            <div id="logins-part" class="content pt-3" role="tabpanel" aria-labelledby="logins-part-trigger">
              ...
              <input type="hidden" name="img1" value="{{ asset('uploads/client-request/'.$_GET['CreativeFileName'])}}" id="img1">
              <input type="hidden" name="img1_name" value="{{$_GET['CreativeFileName']}}" id="img1_name">
              <input type="hidden" name="agencycode" value="{{$_GET['agencyCode']}}" id="agencycode">  
