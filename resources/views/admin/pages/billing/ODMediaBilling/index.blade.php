...
<div class="content-inside p-3">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0">
        <i class="fa fa-user"></i> Submitted Bill Reports For Outdoor
