...
<div class="content-inside p-3">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 text-primary"><i class="fa fa-edit"></i>Bill Submission For AV-TV </h6>
    </div>
    <!-- Card Body -->
    <div class="card-body">
          ...
          <div id="logins-part" class="tab-pane active show">
            <div id="logins-part" class="content pt-3" role="tabpanel" aria-labelledby="logins-part-trigger">
              <div class="row">
                ...
                <div class="col-md-4" >
                  <div class="form-group">
                    <label class="form-control-label">Invoice No.<font color="red">*</font></label>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="form-control-label">RO Date<font color="red">*</font></label>
                    <input  type="text" class="form-control form-control-sm" name="bill_date" id="bill_date"  placeholder="DD-MM-YYYY" value="<?php echo date('d-m-Y', strtotime(now())) ;?>">
                    <span id="date_error" style="color:red;display: none;"></span>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="form-control-label">Telecast Date<font color="red">*</font></label>
              ...
              <div class="row">
                <div class="col-md-4" >
                  <div class="form-group">
                    <label class="form-control-label">Telecast duration. (in seconds)<font color="red">*</font></label>
                ...
                <div class="col-md-4" >
                  <div class="form-group">
                    <label class="form-control-label">No. Of Spots  (numeric)<font color="red">*</font> </label>
                    <input type="text"  name="advtWidth" id="advtWidth"  class="form-control form-control-sm" onkeypress="return isNumber(event)">
                  </div>
                </div>
                <!-- <div class="col-md-4">
                  <div class="form-group">
                    <label class="form-control-label">Difference in Sq. CMS<font color="red">*</font></label>
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="form-control-label">Claimed Amount<font color="red">*</font></label>
                    ...
                    <input  type="hidden" class="form-control form-control-sm" maxlength="40" name="ap_amount" value="">
                    <input type="hidden" name="totaladvtSize" value="" id="totaladvtSize">
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input  type="text" class="form-control form-control-sm" maxlength="40" name="billOfficerName" id="billOfficerName">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="form-control-label">Bill Officer Designation<font color="red">*</font></label>
                    <input  type="text" class="form-control form-control-sm" maxlength="40" name="billOfficerDesign" id="billOfficerDesign">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="form-control-label">Auth. Signatory Name<font color="red">*</font></label>
                    <input  type="text" class="form-control form-control-sm" maxlength="40" name="SignatoryName" id="SignatoryName">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="form-control-label">Auth. Signatory Designation<font color="red">*</font></label>
                    <input  type="text" class="form-control form-control-sm" maxlength="40" name="SignatoryDesign" id="SignatoryDesign">
                  </div>
                </div>
              </div> 
              <input type="hidden" name="img1" value="" id="img1">
              <input type="hidden" name="img1_name" value="" id="img1_name">
              <input type="hidden" name="agencycode" value="" id="agencycode">  
              <input type="hidden" name="rocode" value="" id="rocode">
              <div class="row">
                <!-- start np image upload file-->
                <!-- <div class="col-md-4" >
                  <div class="form-group">
                    <label class="form-control-label">Upload Newspaper<br> Image<font color="red">*</font></label>
                ...
                <!--end np img div upload file end-->
                ...
                <!--end div advt image upload file end-->
