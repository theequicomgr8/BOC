...
@section('content')
@php
$getnpcode=isset($npcodeData)?$npcodeData:[1];
@endphp
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select  id="npcode" name="npcode" class="form-control form-control-sm">
                      <option value=""> Select </option>
                      <option>{{session('UserName')}}</option>
                    <!-- @foreach($getnpcode AS $res)
                      
                      <option value="{{$res->npcode}}" > {{$res->npcode}}</option>
                      @endforeach -->
                    </select>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input  type="text" class="form-control form-control-sm" name="published_date" id="published_date"  placeholder="DD-MM-YYYY" autocomplete="off">
...
<script>
  ...
  $('#statediv').hide();
  $('#npcode').change(function(){
    var npcode = $('#npcode').val();
    console.log(npcode);
    if(npcode=="" || npcode==null){
      $('#npnamediv').hide(); 
      $('#languagediv').hide();
      $('#periodicitydiv').hide();
      $('#publication_placediv').hide();
