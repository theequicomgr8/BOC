          ...
          <div class="tab-content">
            <div id="tab1" class="content pt-3 tab-pane active show" role="tabpanel" aria-labelledby="tab1-trigger">
              ...
              <div id="details_of_owner">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="license_from">License start date / लाइसेंस शुरू होने
                                        की तिथि<font color="red">*</font></label>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <h6>If you want to import through XLS <a href="{{asset('uploads/demo_file.xlsx')}}" target="_blank">Download Sample File</a>
                    </h6>
                  </div>
                  <div class="col-md-3">
                    <input type="radio" name="xls" id="xlxyes" value="1" class="xls" style="pointer-events: {{$pointer}};"> Yes &nbsp; 
                    <input type="radio" name="xls" id="xlxno" value="0" class="xls" checked="checked" style="pointer-events: {{$pointer}};"> No
                  </div>
                </div>
                <br>
                <br>
                <div class="row" id="xls_show" >
                  <div class="col-md-4">
                    <input type="file" name="media_import" class="form-control form-control-sm" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <p>
                          <select name="Applying_For_OD_Media_Type[]" class="form-control form-control-sm mediaclass" style="width: 100%;" id="applying_media_{{$key}}" data-val="showcategory_{{$key}}" tabindex="{{$key}}" {{ $disabled }} style="pointer-events: {{$pointer}};">
                    ...
                    <div class="col-md-4" id="subcategory">
                      <div class="form-group">
                        ...
                        <p>
                          <select name="od_media_type[]" class="form-control-sm form-control subcategory dynemicsub_cat{{$key}} " id="showcategory_{{$key}}" tabindex="{{$key}}" data-eid="showcategory_{{$key}}" {{ $disabled }} style="pointer-events: {{$pointer}};">
                    ...
                    <input type="hidden" name="od_media_id[]" value="{{@$sole->{'Line No_'} ?? ''}}">
                    <div class="col-md-6"></div>
                    <div class="col-md-2" style="padding: 2% 0 0 90%;"></div>
                  </div>
                  @empty
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <p>
                          <select name="Applying_For_OD_Media_Type[]" class="form-control form-control-sm mediaclass" style="width: 100%;" id="applying_media_0" data-val="showcategory_0" tabindex="0" {{ $disabled }} style="pointer-events: {{$pointer}};">
                            <option value="">Select Category</option>
                    ...
                    <div class="col-md-4" id="subcategory">
                      <div class="form-group">
                        ...
                        <p>
                          <select name="od_media_type[]" class="form-control-sm form-control subcategory dynemicsub_cat0" id="showcategory_0" tabindex="0" data-eid="showcategory_0" {{ $disabled }} style="pointer-events: {{$pointer}};">
                            <option value="">Select Sub-Category</option>
                          </select>
                        </p>
                      </div>
                ...
                <div id="details_of_work_done">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label>From Date / की तिथि से : <font color="red">*</font>
                        </label>
                        <p>
    ...
    $(document).ready(function() {
        ...
        $("#add_row_next").click(function() {
            ...
            var html =
                ...
                i +
                '" placeholder="Enter Billing Amount(Rs)" class="form-control form-control-sm" maxlength="14" onkeypress="return onlyNumberKey(event)"></p></div></div><div class="col-md-4"><div class="form-group"><label for="from_date">From date / की तिथि से<font color="red">*</font></label><p><input type="date" name="from_date[]" id="from_date' +
                i +
