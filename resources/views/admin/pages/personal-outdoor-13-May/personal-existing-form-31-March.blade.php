...
<div class="content-inside p-3">
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-normal text-primary">Empanelment-Outdoor Personal Media</h6>
        </div>
        <!-- Card Body -->
    <div class="card-body">
            ...
            <div id="tab1" class="content pt-3 tab-pane active show" role="tabpanel" aria-labelledby="tab1-trigger">
              ...
              <div id="details_of_owner">
                ...
                <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <h6>If you want to import through XLS <a href="{{asset('uploads/location_details_personal.xlsx')}}" target="_blank">Download Sample File</a>
                      </h6>
                    </div>
                    <div class="col-md-3">
                      <input type="radio" name="xls" id="xlxyes" value="1" class="xls"> Yes &nbsp; <input type="radio" name="xls" id="xlxno" value="0" class="xls" checked="checked"> No
                    </div>
                  </div>
                  <br>
                  <br>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <p>
                            <select name="Applying_For_OD_Media_Type[]" class="form-control form-control-sm mediaclass" style="width: 100%;" id="applying_media_{{$key}}" data-val="showcategory_{{$key}}" tabindex="{{$key}}">
                      ...
                      <div class="col-md-4" id="subcategory">
                        <div class="form-group">
                          <label>Media Sub-Category / मीडिया उप-श्रेणी  {{ @$sole->{'OD Media Type'} }}: <font color="red">*</font>
                          </label>
                          <p>
                            <select name="od_media_type[]" class="form-control-sm form-control subcategory mediaclass dynemicsub_cat{{$key}} " id="showcategory_{{$key}}" tabindex="{{$key}}" data-eid="showcategory_{{$key}}">
                  ...
                  <div class="row" style="float:right;margin-top: 6px;margin-right: 0px;">
                    ...
                    <a class="btn btn-primary" id="add_row_media_add">
                ...
                <div id="details_of_work_done">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label>To Date / तिथि तक <font color="red">*</font>
                        </label>
                        <p>
