        ...
        <div class="tab-content">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="HO_Email" placeholder="Enter E-mail" class="form-control form-control-sm" id="email" value="{{$vendor_data[0]['HO E-Mail'] ?? session('email')}}" maxlength="50" onkeyup="return checkUniqueVendor('email', this.value)" {{$read}} tabindex="{{$tab}}" style="pointer-events: {{$pointer}};">
          ...
          <!-- For Add function 8-Feb end -->
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label>Rental Type / किराये का प्रकार {{ @$vendor_data[0]['Rental Agreement'] }}</label>
          ...
          <div class="row" id="xls_show">
            ...
            <div class="row" id="workid{{$key}}">
              ...
              <div class="col-md-2" style="padding: 2% 0 5 90%; display: {{$key==0 ? 'none' :'block'}}"><button class="btn btn-danger remove_row_next" data="{{$key}}" data-hide="workid{{$key}}" style="display: {{ $show; }}"><i class="fa fa-minus"></i> Remove</button>
          ...
          <div class="row" style="float:right;margin-top: 6px;margin-right: 0px;">
            ...
            <div id="details_of_work_done">
              ...
              <div class="row" id="workid{{$key}}">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                      <label>From Date / की तिथि से<font color="red">*</font></label>
                      <p>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                      <label>To Date / तिथि तक :<font color="red">*</font></label>
                      <p>
