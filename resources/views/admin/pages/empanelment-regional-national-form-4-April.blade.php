                   ...
                   <div id="tab1" class="content pt-3 tab-pane active show" role="tabpanel" aria-labelledby="logins-part-trigger">
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                              <label for="Name">Publication Name / प्रकाशन का नाम<font color="red">*</font></label>
                    ...
                    <div class="row">
                     ...
                     @php 
                      ...
                      <div class="col-md-4">
                      <div class="form-group">
                        <label for="claimed_circulation">Down-linking valid upto / डाउन-लिंकिंग तक मान्य है<font color="red">*</font></label>
                      ...
                      <div class="col-md-4">
                      <div class="form-group">
                        <label for="page_length">EMMC license no. / ईएमएमसी लाइसेंस संख्या</label>
                      ...
                      <div class="col-md-4">
                      <div class="form-group">
                        <label for="page_width">Date of EMMC / ईएमएमसी की तिथि</label>
                     ...
                     <div class="col-md-4" >
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="Streaming_Start_Date">Streaming Start Date / स्ट्रीमिंग प्रारंभ तिथि<font color="red">*</font></label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                   ...
                   <div id="tab4" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="information-part-trigger">
                      ...
                      <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputFile">Uplinking & Down-linking certificate of the channel / चैनल का अपलिंकिंग और डाउनलिंकिंग प्रमाणपत्र<font color="red">*</font></label>
                      ...
                      <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputFile">EMMC certificate telecasting over the last 6 months / ईएमएमसी प्रमाणपत्र पिछले 6 महीनों में प्रसारित हो रहा है।<font color="red">*</font></label>
                        <div class="input-group">
                          <div class="custom-file">
                      ...
                      <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputFile">Fixed point chart (FPC) for the previous 6 months from 6AM to 11PM,  during which the channel operated / पिछले 6 महीनों के लिए सुबह 6 बजे से रात 11 बजे तक फिक्स्ड प्वाइंट चार्ट (एफपीसी) जिसके दौरान चैनल संचालित होता है।<font color="red">*</font></label>
                        <div class="input-group">
                          <div class="custom-file">
                      ...
                      <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputFile">Scan copy of cancelled cheque / रद्द किए गए चेक की स्कैन कॉपी।<font color="red">*</font></label>
                        <div class="input-group">
                          <div class="custom-file">
                      ...
                      <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputFile">Teleport operator certificate / टेलीपोर्ट ऑपरेटर प्रमाणपत्र।<font color="red">*</font></label>
                        <div class="input-group">
                      ...
                      <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputFile">Last year's certificate duly signed by the Auditor/Company / पिछले वर्ष का प्रमाणपत्र लेखापरीक्षक/कंपनी द्वारा विधिवत हस्ताक्षरित<font color="red">*</font></label>
                        <div class="input-group">
                          <div class="custom-file">
                      ...
                      <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputFile">A letter attested by Senior Management Level Executive,Giving Name, Designation &  Signatures / वरिष्ठ प्रबंधन स्तर के कार्यकारी द्वारा सत्यापित एक पत्र, जिसमें नाम, पदनाम और हस्ताक्षर दिए गए हैं।<font color="red">*</font></label>
                        <div class="input-group">
                          <div class="custom-file">
                     ...
                     <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputFile">- A letter indicating whether or not the channel would be able to provide a third party certification of the Advertisement telecast for DAVP/ Government of India. / एक पत्र यह दर्शाता है कि चैनल डीएवीपी/भारत सरकार के लिए प्रसारित विज्ञापन के तीसरे पक्ष के प्रमाणीकरण प्रदान करने में सक्षम होगा या नहीं।<font color="red">*</font></label>
                        <div class="input-group">
                          <div class="custom-file">
                     ...
                     <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputFile">A signed list of the different C&S. TV Channel in the Group/Holding Company/ Company to which the applicant channel belongs to / विभिन्न सी एंड एस की एक हस्ताक्षरित सूची। उस ग्रुप/होल्डिंग कंपनी/कंपनी में टीवी चैनल जिससे आवेदक चैनल संबंधित है।<font color="red">*</font></label>
                        <div class="input-group">
                          <div class="custom-file">
                     ...
                     <div class="col-md-12">
                        <div class="form-group clearfix">
                            ...
                            @endif
                            <label for="affirm">I affirm that all the information given by me is true and nothing has been concealed./मैं पुष्टि करता हूं कि मेरे द्वारा दी गई सभी जानकारी सत्य है और कुछ भी छुपाया नहीं गया है।<font color="red">*</font></label>
                          </div>
                        </div>
                     </div>
                     </div>
