...
<div class="content-inside p-3">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-normal text-primary">Rate Settlement of Bulk SMS & OBD</h6>
        </div>
        <div class="card-body">
    ...
    <div id="tab1" class="content pt-3 tab-pane active show" role="tabpanel"aria-labelledby="tab1-trigger">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" name="mobile"id="mobile" {{$disabled}} placeholder="Enter Mobile"onkeypress="return onlyNumberKey(event)" maxlength="10" {{$readonly}} value="{{@$Bluksms->{'Mobile'} ?? ''}}">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label for="State">State / राज्य {{@$Bluksms->{'State'} }}<font color="red">*</font></label>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="city" class="form-control form-control-sm" id="city" placeholder="Enter City" {{$disabled}} maxlength="20" {{$readonly}} value="{{@$Bluksms->{'City'} ?? ''}}">
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="phone_no" class="form-control form-control-sm" id="phone"
                    placeholder="Enter Phon Number" {{$disabled}} maxlength="15"
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label for="Name">Telecom circle / टेलीकॉम सर्कल<font color="red">*</font></label>
       ...
       <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="gst" placeholder="Enter GST"
                    class="form-control form-control-sm" id="gst_no" onkeypress="return isAlphaNumeric(event)"  {{$readonly}} value="{{@$Bluksms->{'GSTN'} ?? ''}}" {{$disabled}}>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="pan_card" placeholder="Enter Pan Card"
                    class="form-control form-control-sm" id="pan_card" maxlength="15"  onkeypress="return isAlphaNumeric(event)" onkeypress="return isAlphaNumeric(event)" {{$readonly}} value="{{@$Bluksms->{'PAN'} ?? ''}}" {{$disabled}}>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
         <label for="TRAI_RC_File_Name">Upload TRAI registration certificate / ट्राई पंजीकरण
                प्रमाणपत्र अपलोड करें</label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="JOC_File_Name">Copy of job order with any ministry, public sector etc. In past 2 years / पिछले 2 वर्षों में किसी भी मंत्रालय, सार्वजनिक क्षेत्र आदि के जॉब ऑर्डर की कॉपी।</label>
            <div class="input-group">
                <div class="custom-file">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="Throughput_File_Name">Throughput per second for empanelment under bulk sms service /
                बल्क एसएमएस सेवा के तहत पैनल में शामिल करने के लिए प्रति सेकेंड थ्रूपुट।</label>
            <div class="input-group">
                <div class="custom-file">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="Bulk_SDP_File_Name">Documentary proof having commercial experience of delivering at least ten (10) crore bulk in a single month for empanelment / पैनल में शामिल
                होने के लिए एक
                महीने में कम से कम दस (10) करोड़ बल्क डिलीवर करने का व्यावसायिक अनुभव रखने वाले
                दस्तावेजी
                प्रमाण।</label>
            <div class="input-group">
                <div class="custom-file">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="OBD_Call_File_Name1">Document issued by the operator/service provider for the capacity of ten (10) lakh calls per day for empanelment under obd services/ ओबीडी सेवाओं
                के तहत पैनल
                में शामिल करने के लिए प्रति दिन दस (10) लाख कॉल की क्षमता के लिए ऑपरेटर/सेवा
                प्रदाता द्वारा
                जारी दस्तावेज।</label>
            <div class="input-group">
                <div class="custom-file">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="OBD_Call_File_Name2">Documentary proof for having commercial experience of
                making fifty
                (50) lakh calls in a month for empanelment under OBD services / ओबीडी सेवाओं के
                तहत पैनल में
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="Affidavit_For_NS_File_Name">An affidavit to the effect that the agency / operator
                has not been
                temporarily suspended or permanently de-empanelment / इस आशय का एक हलफनामा कि
                एजेंसी /
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="Affidavit_For_Dir_File_Name">An affidavit that the proprietor or Director or
                ...
                in a court of
                law and that the agency/ operator with comply all laws in land / एक हलफनामा कि
                एजेंसी के
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="Mobile_number_ODB_File_Name">It should have the database of mobile numbers of their
                ...
                संबंध में
                आवश्यक प्रमाण उपलब्ध कराने चाहिए।</label>
            <div class="input-group">
                <div class="custom-file">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="Incorporation_Cert_File_Name">Certificate of incorporation in India / भारत में निगमन
                का प्रमाण
                पत्र।</label>
            <div class="input-group">
                <div class="custom-file">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="PAN_Upload_File_Name">Upload document for Pan Card / पैन कार्ड के लिए
                दस्तावेज अपलोड
                करें।</label>
            <div class="input-group">
                <div class="custom-file">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="GST_Upload_File_Name">Upload document for GST / जीएसटी के लिए दस्तावेज अपलोड
                करें</label>
            <div class="input-group">
                <div class="custom-file">
