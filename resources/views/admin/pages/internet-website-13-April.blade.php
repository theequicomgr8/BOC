        ...
        <div class="card-body">
            ...
            <form method="post" id="internet_website" enctype="multipart/form-data">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" id="#tab2">Internet Websites Information</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="city" class="form-control form-control-sm" id="city" placeholder="Enter City" maxlength="20" value="{{@$VendorData->{'City'} ?? ''}}" {{$readonly}}>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone_no" class="form-control form-control-sm" id="phone"
                                        placeholder="Enter Phon Number" maxlength="15"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="GST_No" id="GST_No" placeholder="Enter GST No." maxlength="15" value="{{@$VendorData->{'GSTIN'} ?? ''}}" tabindex="{{$tab}}" style="pointer-events: '{{$pointer}}';" onkeypress="return isAlphaNumeric(event)" onkeyup="return checksumsole(this.value)" {{$readonly}}>
                         ...
                         @endphp
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="place_of_publication">Date of registration of website domain /
                                        वेबसाइट डोमेन के पंजीकरण की तिथि<font color="red">*</font></label>
                                    <input type="date" name="date_of_registration" class="form-control form-control-sm" id="date_of_registration" OnKeypress="javascript:return isAlphaNumeric(event,this.value);" value="{{$EM_DA ?? ''}}" {{$readonly}}>
                    ...
                    <div id="tab3" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab1-trigger">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="Name">Account's holder name / खाता धारक का नाम<font color="red">*</font>
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pan_card" class="form-control form-control-sm"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <label for="exampleInputFile"> Report of average monthly unique user count for last
                                                        6 months certified by website auditor.(This report should be Comscore) / वेबसाइट
                                                        ऑडिटर द्वारा प्रमाणित पिछले 6 महीनों की औसत मासिक यूनिक यूजर काउंट की रिपोर्ट
                                                        (यह रिपोर्ट कॉमस्कोर होनी चाहिए) <font color="red">*</font></label>
                                        <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input {{$click}}" name="auditor_report" id="auditor_report" {{$readonly}} style="pointer-events:none;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label for="exampleInputFile"> Upload document for Pan Card / पैन कार्ड के लिए
                                        ...
                                        <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input {{$click}}" name="pan_upload_file_name" id="pan_upload_file_name" {$readonly}} style="pointer-events:none;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label for="exampleInputFile"> Upload document for GST. / जीएसटी के लिए दस्तावेज
                                        ...
                                        <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input {{$click}}" name="gst_upload_file_name" id="gst_upload_file_name"  {{$readonly}} style="pointer-events:none;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label for="exampleInputFile"> 3PAS (party at server) certificate engagement with
                                        ...
                                        <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input {{$click}}" name="pas_certificate_file_name" id="pas_certificate_file_name" {{$readonly}} style="pointer-events:none;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label for="exampleInputFile"> Certificate to insure that websites work owned and
                                        ...
                                        <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input {{$click}}" name="ooic_file_name" id="ooic_file_name" {{$readonly}} style="pointer-events:none;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label for="exampleInputFile">Annexure-A for rates / दरों के लिए अनुलग्नक-ए <font
                                        ...
                                        <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input {{$click}}" name="annexure_a_file_name" id="annexure_a_file_name" {{$readonly}} style="pointer-events:none;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label for="exampleInputFile"> Notarized certificate under name, signature and seal
                                        ...
                                        <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input {{$click}}" name="notarized_certificate" id="notarized_certificate" {{$readonly}} style="pointer-events:none;">
                                            <label class="custom-file-label" id="notarized_certificate2"  for="notarized_certificate">{{$VendorData->{'Notorized Cert_ File Name'} ?? ''}}</label>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                    <label for="exampleInputFile"> Payment fee for Rs. 5000/- (INR) / - payment fee for
                                        Rs. 5000/- (INR) <font color="red">*</font></label>
                                    </label>
                                        <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input {{$click}}" name="fees_payment" id="fees_payment" {{$readonly}} style="pointer-events:none;">
