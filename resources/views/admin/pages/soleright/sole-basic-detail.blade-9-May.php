...
if(@$vendor_data[0]['Modification']=='1' || @$vendor_data[0]['Modification']=='0')
{
$read='readonly';
$tab='-1';
$pointer='none';
        ...
        <div class="card-body">
            ...
            <form enctype="multipart/form-data" method="POST" id="sole_right_media">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{$click}}" style="pointer-events: none;" data-toggle="tab" id="#tab3">Upload
                            Document</a>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="row">
                       ...
                       <!--  @if(@$vendor_data[0]['Modification']!=1)
                        <a class="btn btn-primary pm-next-button" id='file'> Save <i class="fa fa-arrow-circle-right fa-lg" id="tab_4"></i></a>
                        @else
                        <a class="btn btn-primary pm-next-button" id='file2'><i class="fa fa-paper-plane" aria-hidden="true"></i> Save</a>@endif -->
