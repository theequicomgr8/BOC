...
<!--after 30 day form dissabled  -->

    <!-- $today = date('Y-m-d');
    if(@$vendor_data[0]['Document Date']!=null)
    {
        if(@$vendor_data[0]['Document Date']!='1753-01-01 00:00:00.000')
        {
            $document_date=substr(@$vendor_data[0]['Document Date'],0,10);
...
<div class="content-inside p-3">
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-normal text-primary">Empanelment-Category - A Media(Soleright)</h6>
        </div>
        <!-- Card Body -->
        <div class="card-body">
                ...
                <div class="tab-content">
                    ...
                    <div id="tab2" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab1-trigger">
                        ...
                        <div id="radio" style="display: {{$branchdisplayform}};">
                            ...
                            <div class="row" style="float:right;margin-top: 6px;margin-right: 0px; display: {{$branchdisplayform}};" id="addid">
                    ...
                    <div id="tab5" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab1-trigger">
                            ...
                            <table class="table table-striped text-center" id="myTable" style="font-size: 12px;border: 1px solid #cacdd3;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><img src="{{ 'https://pingtrack.azurewebsites.net/public/uploads/sole-right-media/'.$latlong->{ 'Image File Name'}   }}" name="image" alt="img" target="_blank" width="60" height="60"></td>
                                        <td><img src="{{ 'https://pingtrack.azurewebsites.net/public/uploads/sole-right-media/'.$latlong->{ 'Far Image File Name'}   }}" name="image" alt="img" target="_blank" width="60" height="60"></td>
                        ...
                        @endforeach
                        @endif
                        <a class="btn btn-primary" href="{{URL::to('sole-right-list')}}">Make Payment</a><br>
                        <!-- Loop end -->
