                    ...
                    <div>
                      <table class="davpdgdatagrid" cellspacing="0" cellpadding="2" rules="all" border="1" id="GridView2" style="color:Black;border-color:Tan;border-width:1px;border-style:solid;font-size:15px;border-collapse:collapse;">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input name="mobile_station_main_no_program" @if($list->mobile_station_main_no_program!='NA') value="{{$list->mobile_station_main_no_program}}" @endif type="text" maxlength="5" id="GridView2_ctl02_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input name="painting_poetry_rangoli_main_no_program" @if($list->painting_poetry_rangoli_main_no_program!='NA') value="{{$list->painting_poetry_rangoli_main_no_program}}" @endif type="text" maxlength="5" id="GridView2_ctl03_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none"  />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input name="debate_seminar_symposium_main_no_program" @if($list->debate_seminar_symposium_main_no_program!='NA') value='{{$list->debate_seminar_symposium_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl04_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input name="testimonials_main_no_program" @if($list->testimonials_main_no_program!='NA') value='{{$list->testimonials_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl05_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input name="felicitiation_main_no_program" @if($list->felicitiation_main_no_program!='NA') value='{{$list->felicitiation_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl06_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input name="identifying_opinion_main_no_program" @if($list->identifying_opinion_main_no_program!='NA') value='{{$list->identifying_opinion_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl07_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input name="expert_lectures_main_no_program" @if($list->expert_lectures_main_no_program!='NA') value='{{$list->expert_lectures_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl08_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input disabled name="workshop_main_no_program" @if($list->workshop_main_no_program!='NA') value="{{$list->workshop_main_no_program}}" @endif type="text" maxlength="5" id="GridView2_ctl09_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input  name="media_station_workshop_main_no_programm" @if($list->media_station_workshop_main_no_programm!='NA') value='{{$list->media_station_workshop_main_no_programm}}' @endif type="text" maxlength="5" id="GridView2_ctl10_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input disabled name="quiz_competitions_main_no_program" @if($list->quiz_competitions_main_no_program!='NA') value='{{$list->quiz_competitions_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl11_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input  name="public_meeting_main_no_program" @if($list->public_meeting_main_no_program!='NA') value='{{$list->public_meeting_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl12_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:PaleGoldenrod;">
                          ...
                          <td valign="middle">
                            <input  name="multimedia_component_main_no_program" @if($list->multimedia_component_main_no_program!='NA') value='{{$list->multimedia_component_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl13_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input  name="nukkad_natak_main_no_program" @if($list->nukkad_natak_main_no_program!='NA') value='{{$list->nukkad_natak_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl14_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input  name="property_show_main_no_program" @if($list->property_show_main_no_program!='NA') value='{{$list->property_show_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl15_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input  name="megic_show_main_no_program" @if($list->megic_show_main_no_program!='NA') value='{{$list->megic_show_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl16_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input  name="folk_song_main_no_program" @if($list->folk_song_main_no_program!='NA') value='{{$list->folk_song_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl17_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input  name="folk_dance_main_no_program" @if($list->folk_dance_main_no_program!='NA') value='{{$list->folk_dance_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl18_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input  name="folk_drama_main_no_program" @if($list->folk_drama_main_no_program!='NA') value='{{$list->folk_drama_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl19_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:PaleGoldenrod;">
                          ...
                          <td valign="middle">
                            <input  name="av_medium_main_no_program" @if($list->av_medium_main_no_program!='NA') value='{{$list->av_medium_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl20_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:PaleGoldenrod;">
                          ...
                          <td valign="middle">
                            <input  name="snippet_air_dd_main_no_program" @if($list->snippet_air_dd_main_no_program!='NA') value='{{$list->snippet_air_dd_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl21_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:PaleGoldenrod;">
                          ...
                          <td valign="middle">
                            <input  name="other_av_meterial_main_no_program" @if($list->other_av_meterial_main_no_program!='NA') value='{{$list->other_av_meterial_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl22_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:LightGoldenrodYellow;">
                          ...
                          <td valign="middle">
                            <input  name="ten_twelve_stalls_main_no_program" @if($list->ten_twelve_stalls_main_no_program!='NA') value='{{$list->ten_twelve_stalls_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl23_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:PaleGoldenrod;">
                          ...
                          <td valign="middle">
                            <input  name="ujwala_gas_main_no_program" @if($list->ujwala_gas_main_no_program!='NA') value='{{$list->ujwala_gas_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl24_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:PaleGoldenrod;">
                          ...
                          <td valign="middle">
                            <input  name="mudra_loans_main_no_program" @if($list->mudra_loans_main_no_program!='NA') value='{{$list->mudra_loans_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl25_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:PaleGoldenrod;">
                          ...
                          <td valign="middle">
                            <input  name="kisian_credits_card_main_no_program" @if($list->kisian_credits_card_main_no_program!='NA') value='{{$list->kisian_credits_card_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl26_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:PaleGoldenrod;">
                          ...
                          <td valign="middle">
                            <input  name="opening_account_main_no_program" @if($list->opening_account_main_no_program!='NA') value='{{$list->opening_account_main_no_program}}' @endif type="text" maxlength="5" id="GridView2_ctl27_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
                        ...
                        <tr style="background-color:PaleGoldenrod;">
                          ...
                          <td valign="middle">
                            <input  name="other_govt_scheme_main_no_program" @if($list->other_govt_scheme_main_no_program!='NA') value='{{$list->other_govt_scheme_main_no_program}}' @endif  type="text" maxlength="5" id="GridView2_ctl28_txt_main_no_program" disabled="disabled" class="numeric" style="height:10px;width:90px;resize: none" />
                          </td>
                          <td valign="middle">
