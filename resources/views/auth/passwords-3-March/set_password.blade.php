                    ...
                    <div class="login-page float-right">
                        <div class="form-validation mt-20"> 
                            ...
                            @if(session()->has('set_password'))
                              ...
                              @if(session()->has('set_password2'))
                              <div class="alert alert-danger">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                {{ session()->get('set_password2') }}
                              </div>
                              @endif
                            ...
                            <div  id ="resetform01"class="show">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group"><i class="fa fa-user"></i>
                                        <input name="password" type="password" id="password" tabindex="0" class="form-control underline-input" placeholder="Enter Password" >
