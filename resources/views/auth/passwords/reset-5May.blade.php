...
<div class="form-validation mt-20">
    ...
    <div id="resetform01" class="show">
        ...
        <a href="{{URL::to('vendor-login')}}"><i class="fa fa-user"></i> Login</a>
    ...
    <div id="newpassdiv" class="hide">
        ...
        <div class="form-group">
            <div class="form-group" id="pwd-container"><i class="fa fa-unlock-alt"></i>
                <input type="password" name="npassword" id="npassword" class="form-control underline-input" placeholder="Enter New Password" onkeydown="return showProgressbar(this.value)"><span id="passerror"></span>
