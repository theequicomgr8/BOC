        ...
        <div id="resetform01" class="show">
            ...
            <div class="form-group">
                <div class="form-group"><i class="fa fa-user"></i>
                    <input name="email" type="text" id="email" tabindex="0" value="{{ Session()->get('email_for_otp') }}" class="form-control underline-input" placeholder="Enter Email">
                ...
                <div class="form-group"><i class="fa fa-unlock-alt"></i>
                    <input name="mobile_otp" type="text" id="mobile_otp" class="form-control underline-input" placeholder="Enter Your Mobile OTP" maxlength="4">
                    <span id="moberror"></span>
                </div>
