...
<div class="form-validation mt-20">
    ...
    <form method="POST" action="{{URL::to($current_url)}}">
        ...
        <div class="form-group text-left ">
            <button type="submit" class="btn btn-greensea b-0 br-2 pull-right mr-0">Login</button>
        </div>
    </form>
    ...
    <form method="POST" action="{{URL::to($current_url)}}">
        ...
        <div class="form-group">
            <select name="wing_type" id="wing_type" class="form-control underline-input select1" required>
                ...
                <option value="M005">Print Publisher</option>
            </select>
        </div>
        <div class="form-group">
            <select name="login_type" id="login_type" class="form-control underline-input select1" required>
                ...
                <option value="4">Agency Number</option>
            </select>
        </div>
        <input id="userTypeHidden" type="hidden" name="userTypeHidden" value="{{request()->user_type}}">
        <div class="form-group"><i class="fa fa-user"></i>
        ...
        <div class="form-group text-left ">
            ...
            <input type="submit" value="Login" class="btn btn-greensea b-0 br-2 pull-right mr-0">
